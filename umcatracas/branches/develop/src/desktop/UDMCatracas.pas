...
uses
   SysUtils, Classes, ZConnection, UZStartConnection, IniFiles, ZSqlMonitor, ZDbcIntfs,
   Windows;
...
function TDMCatracas.DataAtual: TDateTime;
const
...
begin
  ...
  try
    Stmt := conn.DbcConnection.PrepareStatement(SQL);
    ...
    begin
      ...
      on E: Exception do
         salvarLog('[DataModuleCreate] TDMCatracas.DataAtual: ' + E.Message);
  end;
end;
