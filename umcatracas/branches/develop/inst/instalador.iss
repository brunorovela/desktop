#define AppVersion GetFileVersion('..\build\umcatracas.exe')
#define ServiceName 'SvcUnimestreCatracas'

[Setup]
InternalCompressLevel=ultra
OutputBaseFilename=AtualizaUnimestreCatracas-{#AppVersion}
VersionInfoVersion={#AppVersion}
VersionInfoCompany=Uninformare Informática
VersionInfoDescription=Unimestre Catracas
VersionInfoTextVersion=Unimestre Catracas {#AppVersion}
Compression=lzma/ultra
AppName=Unimestre Catracas
...
Uninstallable=true
AppID={{8FC195AE-E18C-45E8-93C9-1D4884A59EED}
DefaultDirName={reg:HKLM\Software\Uninformare\UNIMESTRE,UniMestreDir|{sd}\UNIMESTRE}
DisableProgramGroupPage=true
DefaultGroupName=UNIMESTRE
CloseApplications=no
UninstallDisplayName=Remover o Unimestre Catracas {#AppVersion}

[Languages]
Name: Portugues; MessagesFile: compiler:Languages\BrazilianPortuguese.isl

[Dirs]
Name: {app}\programas\catracas

[Files]
Source: ..\build\umcatracas.exe; DestDir: {app}\programas; Flags: overwritereadonly ignoreversion; BeforeInstall: StopDeleteService(ExpandConstant('{#ServiceName}')); Languages: 
Source: ..\build\catracas\core.bpl; DestDir: {app}\programas\catracas; Flags: overwritereadonly ignoreversion
Source: ..\build\catracas\henry7x.bpl; DestDir: {app}\programas\catracas; Flags: overwritereadonly ignoreversion
Source: ..\build\catracas\henry8x.bpl; DestDir: {app}\programas\catracas; Flags: overwritereadonly ignoreversion
Source: ..\build\catracas\inner.bpl; DestDir: {app}\programas\catracas; Flags: overwritereadonly ignoreversion
Source: ..\build\libmysql.dll; DestDir: {app}\programas; Flags: overwritereadonly ignoreversion
Source: ..\build\libmySQL50.dll; DestDir: {app}\programas; Flags: overwritereadonly ignoreversion
Source: ..\build\umSQLdebugger.dll; DestDir: {app}\programas; Flags: overwritereadonly ignoreversion
Source: ..\build\Kernel7x.dll; DestDir: {sys}; Flags: overwritereadonly ignoreversion regserver; Attribs: system

[Run]
Filename: {app}\programas\umcatracas.exe; Parameters: /install /silent; WorkingDir: {app}\programas; AfterInstall: SimpleStartService(ExpandConstant('{#ServiceName}'), True, True)

[Registry]
Root: HKLM; Subkey: SOFTWARE\Uninformare\UNIMESTRE; ValueType: string; ValueName: UniMestreDir; ValueData: {app}\

[_ISToolPreCompile]
Name: ..\..\..\..\..\..\tecnologia\Internos\UniControle\trunk\exe\Tools\upx.exe; Parameters: --force ..\build\umcatracas.exe
...
Filename: {app}\programas\Kernel7x.ini; Section: CFG; Key: DEBUG; String: 0
Filename: {app}\programas\Kernel7x.ini; Section: CFG; Key: DBGCL; String: 0
Filename: {app}\programas\Kernel7x.ini; Section: CFG; Key: DEBUGCOM; String: 1

[UninstallDelete]
Name: {app}\programas\umcatracas.exe; Type: files; BeforeInstall: StopDeleteService(ExpandConstant('{#ServiceName}'))
Name: {app}\programas\catracas\core.bpl; Type: files
Name: {app}\programas\catracas\henry7x.bpl; Type: files
Name: {app}\programas\catracas\henry8x.bpl; Type: files
Name: {app}\programas\catracas\inner.bpl; Type: files
Name: {app}\programas\catracas; Type: dirifempty
