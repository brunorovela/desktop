...
;SourceDir=[$UniControle.Projeto$][$Modulo.ds_pasta$]\trunk
...
Source: exe\taminscricoes\TAMInscricoes.exe; DestDir: {app}\programas\taminscricoes; Flags: overwritereadonly ignoreversion; DestName: TAMInscricoes.exe
Source: exe\*.dll; DestDir: {app}\programas\; Flags: sharedfile uninsneveruninstall overwritereadonly replacesameversion
Source: C:\WINDOWS\System32\UMFuncoes.bpl; DestDir: {sys}; Flags: sharedfile uninsneveruninstall overwritereadonly replacesameversion
...
[INI]
Filename: {app}\programas\taminscricoes\unimestre.ini; Section: Conexao; Key: Protocol; String: mysql-5; Flags: createkeyifdoesntexist
Filename: {app}\programas\taminscricoes\unimestre.ini; Section: Conexao; Key: Servidor; String: localhost; Flags: createkeyifdoesntexist
Filename: {app}\programas\taminscricoes\unimestre.ini; Section: Conexao; Key: Banco; String: unimestre; Flags: createkeyifdoesntexist
Filename: {app}\programas\taminscricoes\unimestre.ini; Section: Conexao; Key: Usuario; String: academico; Flags: createkeyifdoesntexist
Filename: {app}\programas\taminscricoes\unimestre.ini; Section: Conexao; Key: Senha; String: E2619A55EE66EA14CA02619741AD13D270; Flags: createkeyifdoesntexist
Filename: {app}\programas\taminscricoes\unimestre.ini; Section: Conexao; Key: Porta; String: 3306; Flags: createkeyifdoesntexist
