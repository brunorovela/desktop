...
type
  ...
  TfrmAulasProvasAcoes = class(TForm)
    ...
    umdtAvaliacao: TUMDateTimePicker;
   ...
   private
    ...
    procedure AtualizarDataAvaliacaoInstucionalCronograma;
     ...
     procedure CriaProvaUltimaAulaCronograma( const data: TDate;
                  const cd_turma: String; const cd_disciplina, cd_professor, nr_anosemestre, cd_grupo, bimestre, tipoDigitacao: Integer );
      ...
      begin
         ...
         begin
            CriaProvaUltimaAulaCronograma(
               ...
               StrToInt(TItemCombo(cbTipoDigitacao.Items.Objects[cbTipoDigitacao.ItemIndex]).getCodigo)
            );
         end;
...
begin
  ...
  begin
    ...
    begin
      ...
      qryInsereDisc.FieldByName('dt_inicio').AsDateTime := umdtAvaliacao.Date;
      qryInsereDisc.FieldByName('dt_fim').AsDateTime    := umdtAvaliacao.Date+
...
begin
   ...
   umdtAvaliacao.setDate(dataUltimaAula);
end;
...
begin
   ...
   begin
      ...
      begin
         chkAI.Checked := True;
         umdtAvaliacao.Date := qryGetAvaliacao.FieldByName('dt_inicio').AsDateTime;
      end
      else
      begin
         chkAI.Checked := False;
...
begin
   ...
   begin
      ...
      begin
         ...
         valor_fim := QuotedStr(DateToStr(umdtFimDiario.Date, ConfiguracaoData));
      end;
...
begin
   ...
   begin
      ...
      begin
         ...
         SQL.Add('INSERT INTO diario_provas(nro_nota, data, anosemestre, turma, disciplina, bimestre, assunto, nr_tipo_digitacao, cd_professor, cd_grupo) ');
         SQL.Add('VALUES (:nro_nota, :data, :nr_anosemestre, :cd_turma, :cd_disciplina, :bimestre, :assunto, :nr_tipo_digitacao, :cd_professor, :cd_grupo)');
