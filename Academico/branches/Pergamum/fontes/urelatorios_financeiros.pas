...
begin
   ...
   begin
      ...
      begin
         sConta := slFormulas.Values['iContaImpressao'];
         sConta := sConta + '=' + slFormulas.Values['iContaColigada'];
         if not frmRepBloquetos.PrepararBloquetosParaEmpresa(sFiltroAux, bAgrupado, sConta, qRelatorios.FieldByName('ds_filtro_bloquetos').AsString, cd_tipo_titulo_filtrado)  then
         begin
            result := false;
            exit;
         end;
   ...
   begin
      if bEmpresa OR bResponsavel then begin
         sConta := slFormulas.Values['iContaImpressao'];
         sConta := sConta + '=' + slFormulas.Values['iContaColigada'];
         if not frmRepBloquetos.PrepararBloquetosParaAluno(sFiltroAux, bAgrupado, sConta, qRelatorios.FieldByName('ds_filtro_bloquetos').AsString, cd_tipo_titulo_filtrado)  then begin
            result := false;
            exit;
         end;
      end else
