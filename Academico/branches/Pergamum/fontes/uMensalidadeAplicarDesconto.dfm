  ...
  object qyMensalidade: TUMZReadOnlyQuery
    ...
    SQL.Strings = (
      ...
      #9'm.anosemestre nr_anosemestre,'
        ...
        '  REPLACE(REPLACE(FORMAT(valorbruto + valorextra, 2), '#39','#39', '#39#39'), ' +
        #39'.'#39', '#39','#39') vl_bruto,'
      '  m.valordesconto,'
  ...
  object qyValoresTotais: TUMZReadOnlyQuery
    ...
    SQL.Strings = (
      'SELECT'
        ...
        'nto, 0) > (m.valorbruto + COALESCE(m.valorextra, 0)) THEN REPLAC' +
        'E(REPLACE(FORMAT((m.valorbruto + COALESCE(m.valorextra,0)), 2), ' +
      ...
      ''
        ...
        #9'REPLACE(REPLACE(FORMAT((m.valorbruto + COALESCE(m.valorextra,0)' +
        ') - COALESCE(m.descontoextra,0), 2), '#39','#39', '#39#39'), '#39'.'#39', '#39','#39') vl_liqu' +
        'ido_antes_condicionais,'
      ''
      
        #9'CASE WHEN (m.valorbruto + COALESCE(m.valorextra, 0)) - COALESCE' +
        '(m.descontoextra, 0) - COALESCE(m.valordesconto, 0) < 0 THEN 0.0' +
        '0'
      
        '       ELSE REPLACE(REPLACE(FORMAT((m.valorbruto + COALESCE(m.va' +
        'lorextra, 0)) - COALESCE(m.descontoextra, 0) - COALESCE(m.valord' +
        'esconto, 0), 2), '#39','#39', '#39#39'), '#39'.'#39', '#39','#39')'
