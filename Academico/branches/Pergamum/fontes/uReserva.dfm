object frmReserva: TfrmReserva
  ...
  object tblPlanos: TUMZQuery
    ...
    SQL.Strings = (
        ...
        '       pl.cd_acao_movimento_desc_cond, pl.cd_acao_movimento_desc' +
        '_fixo, pl.cd_coligada'
      ...
      '('
        ...
        'DATE_FORMAT(pl.dt_vigencia_inicio, '#39'%Y%m%d'#39') <= DATE_FORMAT(NOW(' +
        '), '#39'%Y%m%d'#39')'
      ')'
      'AND ('
      
        '(DATE_FORMAT(pl.dt_vigencia_fim, '#39'%Y%m%d'#39') >= DATE_FORMAT(NOW(),' +
        ' '#39'%Y%m%d'#39')'
      ')'
      ')'
      ')'
