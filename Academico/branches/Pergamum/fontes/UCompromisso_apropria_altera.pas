...
function TfrmApropriaAltera.validaContaCentroIguais(cd_centro, cd_conta: String;
  bInserir: Boolean): Boolean;
  var i   : integer;
      msg : String;
begin
   ...
   begin
      if ((TFinApropriaCP(ListaApropriacoes.Items[i]).getValorCampo('cd_conta')  = cd_conta) AND
         (TFinApropriaCP(ListaApropriacoes.Items[i]).getValorCampo('cd_centro')  = cd_centro))
      Then
      begin
         if bInserir then
         begin
