  ...
  object qryInsert: TUMZQuery
    ...
    SQL.Strings = (
      ...
      'ValorPago, DataPagamento, Situacao, Usuario, Bloqueto, '
        ...
        'al, ds_obs_desc, sn_liberar_descontos'
      ')'
      'VALUES'
      '('
      ...
      ':Usuario, :Bloqueto, :AnoSemestre, '
        ...
        'ional, :ds_obs_desc, :sn_liberar_descontos'
      ')')
    Params = <
      item
        DataType = ftInteger
    ...
    SQLList.Strings = (
        ...
        'nal, ds_obs_desc, sn_liberar_descontos'#13#10')'#13#10'VALUES'#13#10'('#13#10':CodigoAlu' +
        'no,  :cd_resp, :Parcela, :DataVencimento, :dt_competencia, :Turm' +
        'a, :DataEmissao,'#13#10':NossoNumero, :ValorBruto, :ValorDesconto, :De' +
        'scontoExtra, :ValorExtra,'#13#10':ValorTotal, :ValorJuros, :valorjuros' +
        '_fixo, :ValorPago, :DataPagamento, :Situacao,'#13#10':Usuario, :Bloque' +
        'to, :AnoSemestre, '#13#10':DataBaseCorrecao, :IndiceCorrecao, :Curso, ' +
        ':Depto, :Tipo, :sn_credito_parcela, :cd_mensalidade_origem, :nr_' +
        'creditos,'#13#10':ds_historico, :cd_tipo_titulo, :cd_plano_conta, :cd_' +
        'centro_custo, :cd_caixa, :ValorCredito, :CodItemPlano, :cd_chequ' +
        'e_devolvido, :cd_coligada, :SN_NFE_GERADA, :NR_NF,'#13#10':ds_autentic' +
        'a_impressao, :VL_PERCENTUAL_DIVISAO, :cd_desc_condicional, :ds_o' +
        'bs_desc, :sn_liberar_descontos'#13#10')')
    Left = 192
    Top = 310
    ParamData = <
      item
