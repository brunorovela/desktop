...
begin
  ...
  begin
     ...
     with qryAlteraCompraAcumulada do begin
         Close;
         SQL.Clear;
         SQL.Add(
           ' UPDATE comp_acumulados SET sn_pago = 0 WHERE cd_compra in       ' +
           ' (select cd_compra from comp_estoque_mensalidade WHERE cd_mensalidade = :CdMensalidade)  ');
         ParamByName('CdMensalidade').AsInteger  := tblMensalidadescd_mensalidade.AsInteger;
         ExecSQL;
     end;
