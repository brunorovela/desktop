...
begin
   ...
   begin
      ...
      begin
         valorBruto :=
            qyDadosMensalidade.FieldByName('valorbruto').AsCurrency - RoundFloat(((qyDadosMensalidade.FieldByName('valorbruto').AsCurrency - qyDadosMensalidade.FieldByName('DescontoExtra').AsCurrency)*indicePercentual), 2);
      end;
