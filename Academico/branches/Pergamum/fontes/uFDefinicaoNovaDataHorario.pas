...
begin
   ...
   begin
      ...
      begin
         Result := TfrmReajusteAulasTurma.ajustarAulasHoras(ListaExecucao, ListaHorariosDasDisciplinas, nr_anosemestre, cd_turma, frmDefinicaoNovaDataHorario.umdtData.Date);
         if NOT(Result) then
         begin
            Exit;
         end;
