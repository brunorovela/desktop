object DMDiario: TDMDiario
  ...
  object qTurmas: TUMZQuery
    ...
    SQL.Strings = (
        ...
        'select DT.*, P.NM_PESSOA AS NOME, D.DESCRICAO, C.DESCRICAO AS DS' +
        'CURSO'
      'from DIARIO_TURMAS DT, PESSOAS P, DISCIPLINAS D, CURSOS C'
      'where'
      ...
      'ORDER BY DT.CURSO, DT.TURMA, D.DESCRICAO')
    Params = <>
    Left = 16
    Top = 128
