...
begin
   ...
   begin
      Mensagem('Você deve selecionar uma data de sáida do curso maior ou igual a data de saída da turma!', '', MB_OK + MB_ICONERROR, Handle);
      exit;
   end;

   if (Self.FICodSituacao in [3,4,5,6,7]) then
   begin
