...
uses
  ...
  ZDataset, UZDataset, uLoginManager, ZSqlUpdate; 
...
type
  ...
  public
    ...
    Function PrepararBloquetosParaImpressao(sFiltro : String; Agrupado : Boolean; ContaImpressao : String; bPerguntar : Boolean = true; DataBoleto : TDateTime = 0; ds_filtro_boletos : String = ''; cd_tipo_titulo: String = '') : Boolean;
   ...
   = mrYes THEN begin
         while not qyBlImp.Eof do begin
            ...
            if Dia = 0 then begin // Precisa atualizar
               ...
               qBoleto.SQL.Text :=
                ' SELECT m.cd_mensalidade, m.datavencimento, m.parcela, p.nm_pessoa FROM mensalidades as m JOIN pessoas p ON (m.cd_resp = p.cd_pessoa)' +
                ' WHERE ' + sFiltro +
...
Function TfrmRepBloquetos.PrepararBloquetosParaImpressao(sFiltro : String; Agrupado : Boolean; ContaImpressao : String; bPerguntar : Boolean = true; DataBoleto : TDateTime = 0; ds_filtro_boletos : String = ''; cd_tipo_titulo: String = '' ) : Boolean;
const
   ...
   S_SQL_CAMPO_CORRECAO =
     '   GET_DESCONTOS(m2.cd_mensalidade, [DATA_CORRECAO]) as desconto_corrigido, ' +
     '   IFNULL(m2.valorbruto, 0) - IFNULL(m2.descontoextra, 0) + IFNULL(m2.valorjuros, 0) + IFNULL(m2.valorextra, 0) + GET_ACRESCIMOS(m2.cd_mensalidade, [DATA_CORRECAO]) as valor_corrigido, ';
