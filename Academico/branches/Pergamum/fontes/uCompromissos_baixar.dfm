object frm_Compromisso_Baixar: Tfrm_Compromisso_Baixar
  ...
  object pnBaixa: TPanel
    ...
    object txtValorTotalPago: TUMEditMonetario
      ...
      TabOrder = 0
      Text = '0,00'
      OnEnter = txtValorTotalPagoEnter
  ...
  object qyCompromisso: TUMZQuery
    ...
    SQLList.Strings = (
        ...
        'O,'#13#10'   CP.cd_titulo,'#13#10'   P.NM_PESSOA,'#13#10'   ROUND(SUM(M.VL_ENTRADA' +
        '),2) VL_ENTRADAS,'#13#10'   ROUND(SUM(M.VL_SAIDA),2) VL_SAIDAS,'#13#10'   CP' +
        '.cd_titulo_principal,'#13#10'   CP.vl_multa,'#13#10'   CP.vl_mora,'#13#10'   CP.vl' +
        '_desconto'#13#10'FROM'#13#10'   FIN_CONTAS_PAGAR CP'#13#10'      LEFT JOIN FIN_MOV' +
        '_CP M ON'#13#10'         (M.CD_TITULO = CP.CD_TITULO) AND'#13#10'         (M' +
        '.CD_COLIGADA = CP.CD_COLIGADA)'#13#10'      JOIN PESSOAS P ON'#13#10'       ' +
        '  (CP.CD_PESSOA = P.CD_PESSOA)'#13#10'WHERE'#13#10'   CP.CD_TITULO = :CD_TIT' +
        'ULO AND'#13#10'   CP.CD_COLIGADA = :CD_COLIGADA'#13#10'GROUP BY'#13#10'   CP.CD_TI' +
        'TULO')
    Left = 232
    Top = 56
    ParamData = <
    ...
    object qyCompromissovl_multa: TFloatField
      FieldName = 'vl_multa'
    end
    object qyCompromissovl_mora: TFloatField
      FieldName = 'vl_mora'
    end
    object qyCompromissovl_desconto: TFloatField
