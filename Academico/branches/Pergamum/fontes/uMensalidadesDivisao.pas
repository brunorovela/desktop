...
begin
   ...
   begin
      ...
      begin
         valorBruto :=
            RoundFloat(((tblMensalidadesValorBruto.AsCurrency - tblMensalidadesDescontoExtra.AsCurrency)*indicePercentual), 2);
      end;
      ...
      descontoFixo := RoundFloat(qryDescontosPlano.FieldByName('vl_desc_fixo_plano').AsCurrency * indicePercentual, 2);
      ...
      descontoCondicional := RoundFloat(qryDescontosPlano.FieldByName('vl_desc_cond_plano').AsCurrency * indicePercentual, 2);
   end;
...
begin
   ...
   begin
      ...
      begin
         valorBruto :=
            tblMensalidadesValorBruto.AsCurrency - RoundFloat(((tblMensalidadesValorBruto.AsCurrency - tblMensalidadesDescontoExtra.AsCurrency)*indicePercentual), 2);
      end;
      ...
      descontoFixo := tblMensalidadesDescontoExtra.AsCurrency - qryDescontosPlano.FieldByName('vl_desc_fixo_plano').AsCurrency;
      // Soma aos descontos que devem ser mantidos no aluno a parte dele da divisão dos fixos do plano
      descontoFixo := descontoFixo + qryDescontosPlano.FieldByName('vl_desc_fixo_plano').AsCurrency - RoundFloat(qryDescontosPlano.FieldByName('vl_desc_fixo_plano').AsCurrency * indicePercentual, 2);
      ...
      descontoCondicional := tblMensalidadesValorDesconto.AsCurrency - qryDescontosPlano.FieldByName('vl_desc_cond_plano').AsCurrency;
      // Soma aos descontos que devem ser mantidos no aluno a parte dele da divisão dos condicionais do plano
      descontoCondicional := descontoCondicional + qryDescontosPlano.FieldByName('vl_desc_cond_plano').AsCurrency - RoundFloat(qryDescontosPlano.FieldByName('vl_desc_cond_plano').AsCurrency * indicePercentual, 2);
   end;
