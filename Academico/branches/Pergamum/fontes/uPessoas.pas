...
uses
  ...
  RegExpr, ZSqlUpdate, VirtualTrees, uEditorContatosPessoa, UMAjuda, uMensagem, uFSplash, uDM;
...
begin
   ...
   begin
      ...
      if (tblPessoatp_cert.AsInteger <> 2)
...
procedure Tfrm_Pessoas.gravalog();
var
