...
type
  TfrmReclassificar = class(TForm)
    ...
    qryUpdApropria: TUMZQuery;
    qryInsApropria: TUMZQuery;
    qryApagarOrigem: TUMZQuery;
    qryUpdateCompromisso: TUMZQuery;
    qryApagarCompromisso: TUMZQuery;
    qryUpdateAgrupamento: TUMZQuery;
    qryApagarAgrupamentos: TUMZQuery;
...
begin
   ...
   begin
      // A conta existe, basta alterar - usando lógica com REPLACE, para juntar duas contas se ela já existir
      qryUpdApropria.ParamByName('CD_CONTA_PARA').AsString := edPara.Text;
      qryUpdApropria.ParamByName('CD_CENTRO_PARA').AsString := edCentro.Text;
      qryUpdApropria.ParamByName('CD_MOVIMENTO_TE').AsString := edMovimento.Text;
      qryUpdApropria.ParamByName('DS_CONTA').AsString := cbDe.Text;
      qryUpdApropria.ExecSQL;

      // Agora, apagar a conta de origem.
      qryApagarOrigem.ParamByName('CD_MOVIMENTO_TE').AsString := edMovimento.Text;
      qryApagarOrigem.ParamByName('DS_CONTA').AsString := cbDe.Text;
      qryApagarOrigem.ExecSQL;

      // Alterar o compromisso
      qryUpdateCompromisso.ParamByName('CD_CONTA_PARA').AsString := edPara.Text;
      qryUpdateCompromisso.ParamByName('CD_CENTRO_PARA').AsString := edCentro.Text;
      qryUpdateCompromisso.ParamByName('CD_MOVIMENTO_TE').AsString := edMovimento.Text;
      qryUpdateCompromisso.ParamByName('DS_CONTA').AsString := cbDe.Text;
      qryUpdateCompromisso.ExecSQL;

      // Excluir o compromisso
      qryApagarCompromisso.ParamByName('CD_MOVIMENTO_TE').AsString := edMovimento.Text;
      qryApagarCompromisso.ParamByName('DS_CONTA').AsString := cbDe.Text;
      qryApagarCompromisso.ExecSQL;

      // Alterar o compromisso agrupado (origem)
      qryUpdateAgrupamento.ParamByName('CD_CONTA_PARA').AsString := edPara.Text;
      qryUpdateAgrupamento.ParamByName('CD_CENTRO_PARA').AsString := edCentro.Text;
      qryUpdateAgrupamento.ParamByName('CD_MOVIMENTO_TE').AsString := edMovimento.Text;
      qryUpdateAgrupamento.ParamByName('DS_CONTA').AsString := cbDe.Text;
      qryUpdateAgrupamento.ExecSQL;

      // Excluir o compromisso agrupado (origem)
      qryApagarAgrupamentos.ParamByName('CD_MOVIMENTO_TE').AsString := edMovimento.Text;
      qryApagarAgrupamentos.ParamByName('DS_CONTA').AsString := cbDe.Text;
      qryApagarAgrupamentos.ExecSQL;    
   end else begin
