...
begin
  ...
  End
      ...
      // Método que habilita ou não os checks referentes as senhas provisórias
...
begin
   ...
   if (qyPaiResp.FieldByName('ds_senha').AsString = '') AND (edSenha.Text = '*****') then begin
    ...
    begin
       DM.CriarConsulta(qyUpdateProvisoria);
       try
          qyUpdateProvisoria.SQL.Text := ''
          + ' UPDATE '
          + '   pessoas '
          + ' SET '
          + '   sn_senha_provisoria = :provisoria '
          + ' WHERE '
          + '   cd_pessoa = :cd_pessoa';
