...
begin
   ...
   DM.qyTiposTitulo.SQL.Add('  sn_ativo = 1              ');
   DM.qyTiposTitulo.SQL.Add('  AND ct_tipo_titulo = 2    ');  // 2 = Contas a Pagar
   DM.qyTiposTitulo.SQL.Add('  AND cd_coligada_matriz =  ' +
      IntToStr(DM.GetUsuarioLogado.GetColigadaLogada.Codigo)
   );
