...
uses
   ...
   Buttons, ZAbstractRODataset, UZDataset, UMAjuda, General;
...
begin
   ...
   begin
      ...
      // Busca o total de descontos fixos e condicionais do plano de pagamento da parcela
      vlDescFixoPlano := GetDescontoFixoPlanoPagamento(cdsParcelasDivididasIDX_PARCELA.AsString);
      vlDescCondPlano := GetDescontoCondicionalPlanoPagamento(cdsParcelasDivididasIDX_PARCELA.AsString);
      ...
      cdsParcelasDivididasVL_BOLSA.AsCurrency := cdsParcelasDivididasVL_BOLSA.AsCurrency - vlDescFixoPlano;
      // Soma aos descontos que devem ser mantidos no aluno a parte dele da divisão dos fixos do plano
      cdsParcelasDivididasVL_BOLSA.AsCurrency := cdsParcelasDivididasVL_BOLSA.AsCurrency + vlDescFixoPlano - RoundFloat(vlDescFixoPlano * indiceDivisao, 2);
      ...
      cdsParcelasDivididasVL_DESCONTO.AsCurrency := cdsParcelasDivididasVL_DESCONTO.AsCurrency - vlDescCondPlano;
      // Soma aos descontos que devem ser mantidos no aluno a parte dele da divisão dos condicionais do plano
      cdsParcelasDivididasVL_DESCONTO.AsCurrency := cdsParcelasDivididasVL_DESCONTO.AsCurrency + vlDescCondPlano - RoundFloat(vlDescCondPlano * indiceDivisao, 2);
   end;
...
begin
   ...
   begin
      ...
      cdsParcelasDivididasVL_BOLSA.AsCurrency := RoundFloat(vlDescFixoPlano * indiceDivisao, 2);
      ...
      cdsParcelasDivididasVL_DESCONTO.AsCurrency := RoundFloat(vlDescCondPlano * indiceDivisao, 2);
   end;
