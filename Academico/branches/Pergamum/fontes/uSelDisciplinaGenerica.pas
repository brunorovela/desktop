...
uses
  ...
  DB, ZAbstractRODataset, ZAbstractDataset, UZDataset, uDM, uUsuario;
...
begin
   ...
   qyDisciplinasGenericas.ParamByName('codaluno').AsInteger := iCodigoAluno;
   ...
   qyDisciplinasGenericas.ParamByName('curso').AsString := sCurso;
