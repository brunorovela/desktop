...
type
  TfrmContAulasProvas = class(TForm)
    ...
    qCronogramasdt_prova: TDateTimeField;
   ...
   begin
      with qCronogramas do begin
         ...
         SQL.Text := ''
            ...
            + '   dc.ds_categoria, '
            + '   MIN(sub_d.data) dt_prova '
            { + '   (SELECT sub_d.data '
            + '        from diario_provas sub_d '
            + '      WHERE '
            + '        sub_d.turma = crono.turma '
            + '        AND sub_d.anosemestre = crono.anosemestre '
            + '        AND sub_d.disciplina = crono.disciplina '
            + '        AND sub_d.cd_professor = crono.cd_professor '
            + '        order by sub_d.nro_nota LIMIT 1) '
            + '     as dt_prova  '
            }
            + 'FROM '
            ...
            + '      LEFT JOIN diario_provas sub_d ON ( '
            + '  		    sub_d.turma = crono.turma '
            + '        	AND sub_d.anosemestre = crono.anosemestre '
            + '        	AND sub_d.disciplina = crono.disciplina '
            + '        	AND sub_d.cd_professor = crono.cd_professor '
            + '       	AND sub_d.bimestre = crono.bimestre '
            + '      ) '
            + 'WHERE '
            + '   1 = 1 ';
         ...
         sAux := sAux + '   GROUP BY crono.cd_cronograma ';
         ...
         begin
            ...
            MessageBox(Handle, 'Favor selecionar pelo menos um filtro.', 'Atenção', MB_ICONEXCLAMATION or MB_OK)
         end;
