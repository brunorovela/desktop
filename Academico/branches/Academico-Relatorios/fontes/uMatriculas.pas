...
type
  ...
  private
    ...
    procedure TranferirTurmaDisciplina( Const disciplina, cd_turma_nova, cd_turma_antiga, cd_curso: String; anosemestre, cd_pessoa: Integer);
  public
...
procedure TfrmMatriculas.TranferirTurmaDisciplina(const disciplina, cd_turma_nova, cd_turma_antiga,
  cd_curso: String; anosemestre, cd_pessoa: Integer);
CONST
