...
type
  TuFrmListarMovimentosCaixas = class(TForm)
    ...
    qryListaMovDS_CAIXA: TStringField;
...
uses uTesouraria_Planilha, uCamposPlanilhas;
...
var
   i: Integer;
begin
   DM.MontarPlanilha(grd, 'planilha_caixas_filtros_campos');
...
begin
   ...
   begin
      frm_Tesouraria_Planilha.umdtDataInicial.Date := qryListaMovDT_MOVIMENTO.AsDateTime;
      frm_Tesouraria_Planilha.umdtDataFinal.Date := qryListaMovDT_MOVIMENTO.AsDateTime;
   end;
...
procedure TuFrmListarMovimentosCaixas.sbSelecionarColunaClick(Sender: TObject);
begin
   // Selecionar as colunas
   Application.CreateForm(TfrmSelColunas, frmSelColunas);
   frmSelColunas.SelecionaColunas(grd, 'planilha_caixas_filtros_campos');
end;
