...
Var
   ...
   linha, coluna, i, j,contadorErros, cd_pessoa, ultimalinha: Integer;
...
begin
   ...
   try
      ...
      begin
            ...
            //verifca se é a ultima linha
            if (nm_coligada + ds_status + ds_uf + ds_cidade) = '' then
             begin
              ultimalinha := i;
              break;
             end
   ...
   if (sheet.cells[i,1].Text = '' ) then
     begin
      ...
      begin
          ...
          Mensagem('Não foi possível importar a planilha, pois há: '+intToStr(contadorErros)+' linha(s) faltando o preenchimento da unidade. Favor tentar novamente.');
