   ...
   begin
      ...
      begin
         ...
         begin
            ...
            fPessoasInformacoes.qryPessoasInfoFiltrar.Locate('cd_informacao', cd_informacao, []);

            fPessoasInformacoes.qryPessoasInfoFiltrar.Edit;
            fPessoasInformacoes.qryPessoasInfoFiltrarcd_pessoa.AsInteger := frm_Alunos.tblPessoacd_pessoa.AsInteger;
