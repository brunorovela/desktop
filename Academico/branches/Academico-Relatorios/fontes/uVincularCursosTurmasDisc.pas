...
type
  Tf_vincular_cursos_turmas_disc = class(TForm)
    ...
    qyVerificaDepartamentosCD_COLIGADA: TSmallintField;
  ...
  private
    ...
    procedure VincularCurso(CdCurso : String; CdAnoSemestre : Integer; CdDepto: Integer = 0; const ColigadaId: Integer = 0);
...
procedure Tf_vincular_cursos_turmas_disc.VincularCurso(CdCurso: String;
   CdAnoSemestre: Integer; CdDepto: Integer = 0; const ColigadaId: Integer = 0);
var
   CdPrazo, CdTipoPrazo : Integer;
   sIgnorar: String;
const
   sSqlVincularCursotemp =
   'INSERT IGNORE INTO dia_prazos_turmas                                                                              '+
...
begin
   ...
   qyVincularCurso.ParamByName('cd_coligada').AsInteger := ColigadaId;
   ...
   qyVerificaVincularCurso.ParamByName('cd_coligada').AsInteger := ColigadaId;
...
begin
   ...
   begin
      VincularCurso(
         qyVerificaDepartamentosCD_CURSO.AsString,
         NrAnosem,
         StrToInt(CdDepto),
         qyVerificaDepartamentosCD_COLIGADA.AsInteger);
