...
const
   SQL_COPIA_PLANO_PAGAMENTO =
      ...
      ' NR_FORMULA_DIAS, NR_ORDEM, SN_PULAR_SABADOS ,SN_PULAR_DOMINGOS, SN_PULAR_FERIADOS '+
      ' ) ' +
      ' SELECT ' +
      ...
      '  SN_PULAR_SABADOS , SN_PULAR_DOMINGOS, SN_PULAR_FERIADOS '   +
      ' FROM FIN_PLANOS ' +
   ...
   SQL_COPIA_ITENS_PLANO =
      ...
      ' NR_FORMULA_VENCTO, NR_FORMULA_OPERADOR, NR_FORMULA_DIAS, SN_BLOQUEADO  ' +
      ') SELECT '+
...
begin
   ...
   if StrToFloat(arrDistrato.Campo['VL_MENSALIDADE'])  > 0 then begin
