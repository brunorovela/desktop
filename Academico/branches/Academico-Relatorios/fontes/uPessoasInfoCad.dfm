object fPessoasInfoCad: TfPessoasInfoCad
      ...
      object Panel3: TPanel
        ...
        object pnCima: TPanel
          ...
          object dbDsInformacao: TDBMemo
            ...
            DataSource = fPessoasInformacoes.dsPessoasInfoFiltrar
            MaxLength = 1000
        ...
        object pnBaixo: TPanel
          ...
          object DBEdit4: TDBEdit
            ...
            DataSource = fPessoasInformacoes.dsPessoasInfoFiltrar
            TabOrder = 0
            OnKeyPress = dbDependenteKeyPress
          end
        ...
        object pnMeio: TPanel
          ...
          object Label20: TLabel
            ...
            Hint = 
              'Informe um nome e tecle ENTER para localizar entre os nomes seme' +
              'lhantes dispon'#237'veis no banco de dados.'
            Caption = 'Complemento de Inscri'#231#227'o'
            ParentShowHint = False
            ShowHint = True
          end
          object Label21: TLabel
            ...
            Hint = 
              'Informe um nome e tecle ENTER para localizar entre os nomes seme' +
              'lhantes dispon'#237'veis no banco de dados.'
            Caption = 'Data de Nascimento do dependente'
            ParentShowHint = False
            ShowHint = True
          end
          ...
          object dbDependente: TDBEdit
            Left = 9
            Top = 19
            Width = 383
            Height = 24
            DataField = 'nm_dependente'
            DataSource = fPessoasInformacoes.dsPessoasInfoFiltrar
            TabOrder = 0
            OnKeyPress = dbDependenteKeyPress
          end
  ...
  object qryInserirPessoasInfoObservacao: TUMZQuery
    Connection = DM.db
    SQL.Strings = (
      'INSERT INTO'
      '   pessoas_info_observacoes('
      '      cd_informacao,'
      '      cd_usuario_registrou,'
      '      me_observacao,'
      '      dt_observacao,'
      '      ds_status'
      '   )'
