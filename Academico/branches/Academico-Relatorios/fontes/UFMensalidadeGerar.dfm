  ...
  object pnlGeral: TPanel
    ...
    object gbInfo: TGroupBox
      ...
      object umdtVencto: TUMDateTimePicker
        ...
        OnChangeDate = umdtVenctoChangeDate
        Date = 42566.000000000000000000
  ...
  object qryPlanosConta: TUMZReadOnlyQuery
    ...
    SQL.Strings = (
      ...
      '   CD_COLIGADA_MATRIZ = :CD_COLIGADA_MATRIZ'
        ...
        '   AND (IFNULL(sn_restringir_permissao,0) = 0 OR :sn_permissao_r' +
        'estrita = 1)')
    Params = <
      item
        DataType = ftUnknown
  ...
  object qryTurmasPessoa: TUMZReadOnlyQuery
    ...
    SQL.Strings = (
      ...
      ''
        ...
        'INNER JOIN COLIGADAS C ON ( C.CD_COLIGADA = T.CD_COLIGADA AND C.' +
        'CD_COLIGADA_MATRIZ = :CD_COLIGADA_MATRIZ ) '
      'WHERE'
