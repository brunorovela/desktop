object frm_Tesouraria_GerarMovimentacao: Tfrm_Tesouraria_GerarMovimentacao
  Left = 201
  Top = 174
  ...
  object pgCompromisso: TPageControl
    ...
    object tsInfGerais: TTabSheet
      ...
      object Label10: TLabel
        ...
        Width = 115
        Height = 13
        Caption = 'Valor da Movimenta'#231#227'o:'
  ...
  object qyPlanoContas: TUMZQuery
    ...
    object qyPlanoContascd_caixa: TIntegerField
      FieldName = 'cd_caixa'
      Origin = 'WMESTRE12.apropriacao_te.cd_caixa'
    end
    object qyPlanoContasdt_movimento: TDateTimeField
  ...
  object qyMovimentacao: TUMZQuery
    ...
    object qyMovimentacaocd_caixa: TIntegerField
      FieldName = 'cd_caixa'
    ...
    object qyMovimentacaonr_documento: TStringField
      FieldName = 'nr_documento'
      Origin = 'WMESTRE12.movimentacao_te.nr_documento'
      Size = 50
    end
    object qyMovimentacaods_movimento: TStringField
  ...
  object updPlanoContas: TZUpdateSQL
    ModifySQL.Strings = (
      ...
      '  cd_caixa = :OLD_cd_caixa and'
      '  dt_movimento = :OLD_dt_movimento and'
      '  cd_conta = :OLD_cd_conta and'
      '  cd_centro = :OLD_cd_centro and'
      '  vl_movimento = :OLD_vl_movimento')
    InsertSQL.Strings = (
      'insert into apropriacao_te'
      
        '  (nr_sequencia, cd_caixa, dt_movimento, cd_conta, cd_centro, vl' +
        '_movimento)'
      'values'
      
        '  (:nr_sequencia, :cd_caixa, :dt_movimento, :cd_conta, :cd_centr' +
        'o, :vl_movimento)')
    DeleteSQL.Strings = (
      'delete from apropriacao_te'
      'where'
      '  nr_sequencia = :OLD_nr_sequencia and'
      '  cd_caixa = :OLD_cd_caixa and'
      '  dt_movimento = :OLD_dt_movimento and'
