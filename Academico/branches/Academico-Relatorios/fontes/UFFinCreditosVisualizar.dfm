object frmFinCreditosVisualizar: TfrmFinCreditosVisualizar
  Left = 0
  Top = 0
  ...
  object pnlTitulo: TPanel
    ...
    Align = alTop
    BevelOuter = bvNone
    Caption = 'CR'#201'DITOS DA PESSOA'
    Color = clBlue
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindow
    Font.Height = -11
  ...
  object qryCreditos: TZReadOnlyQuery
    ...
    SQL.Strings = (
      ...
      '        FIN_MOV_CR M'
      '      WHERE'
      '        M.CD_MENSALIDADE_CREDITO = C.CD_MENSALIDADE'
      '    ),'
      '  0) VL_USADO,'
      '  COALESCE('
      '    ('
    ...
    object qryCreditosCD_MENSALIDADE: TIntegerField
      FieldName = 'CD_MENSALIDADE'
      Required = True
    end
    ...
    object qryCreditosDS_MOTIVO: TMemoField
      FieldName = 'DS_MOTIVO'
      BlobType = ftMemo
    end
  ...
  object cdsCreditos: TClientDataSet
    ...
    object cdsCreditosCD_MENSALIDADE: TIntegerField
      FieldName = 'CD_MENSALIDADE'
      Required = True
    end
    ...
    object cdsCreditosDS_MOTIVO: TMemoField
      FieldName = 'DS_MOTIVO'
      BlobType = ftMemo
    end
