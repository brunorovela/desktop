...
uses
  ...
  StdCtrls, Mask, ComCtrls, ImgList, ToolWin, md5, Menus, ZAbstractRODataset,
  ZAbstractDataset, ZDataset, UZDataset, uDM;
...
type
  ...
  public
    { Public declarations }
    procedure Filtra(tipo: Parametros; permAlterar: Boolean);
  end;
...
procedure TfrmParametros.Filtra(tipo: Parametros; permAlterar: Boolean);
begin
