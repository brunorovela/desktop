object frmCursos: TfrmCursos
  ...
  object qyGrades: TUMZQuery
    ...
    SQLList.Strings = (
        ...
        #13#10'  SN_PADRAO,'#13#10'  NR_PERC_MAX_REPROVACAO'#13#10'FROM'#13#10'  GRADES'#13#10'WHERE'#13 +
        #10'  CD_CURSO = :CD_CURSO AND SN_ATIVO = '#39'S'#39'  '#13#10'ORDER BY'#13#10'  CD_GRA' +
        'DE, DS_GRADE')
    Left = 770
    Top = 524
    ParamData = <
