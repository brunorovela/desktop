...
uses
  ...
  uCadConvenioPgto, General, uCadConvenioEmpresaLog;
...
begin
   frmCadConvenioPgto.qyNfeConveniosEmpresas.Cancel;
...
begin
   if frmCadConvenioPgto.qyNfeConveniosEmpresas.State in [dsEdit] then
   begin
...
var
   bValor : Boolean;
begin
   bValor   := not TBlobField(frmCadConvenioPgto.qyNfeConveniosEmpresas.FieldByName('me_pdf')).IsNull;
   result   := bValor;
end;
...
begin
   ...
   begin
      ...
      if frmCadConvenioPgto.qyNfeConveniosEmpresasdt_inicial.AsDateTime <> 0 then
      begin
         ds_alteracoes := ds_alteracoes + chr(13) + 'Data Inicial: ' + datetostr(frmCadConvenioPgto.qyNfeConveniosEmpresasdt_inicial.AsDateTime);
      end
      else
      begin
      ...
      if frmCadConvenioPgto.qyNfeConveniosEmpresasdt_final.AsDateTime <> 0 then
      begin
         ds_alteracoes := ds_alteracoes + chr(13) + 'Data Final: ' + datetostr(frmCadConvenioPgto.qyNfeConveniosEmpresasdt_final.AsDateTime);
      end
      else
      begin
      ...
      if frmCadConvenioPgto.qyNfeConveniosEmpresassn_ativo.AsInteger = 1 then
      begin
         sn_ativo_new := 'Sim';
      end
      else
   ...
   begin
      ...
      if objConvenio.dt_inicial <> frmCadConvenioPgto.qyNfeConveniosEmpresasdt_inicial.AsDateTime then
      begin
         ds_alteracoes := ds_alteracoes + chr(13) + 'Data Inicial: Mudou de ' + datetostr(objConvenio.dt_inicial) + ' para ' + datetostr(frmCadConvenioPgto.qyNfeConveniosEmpresasdt_inicial.AsDateTime);
      end;

      if objConvenio.dt_final <> frmCadConvenioPgto.qyNfeConveniosEmpresasdt_final.AsDateTime then
      begin
         ds_alteracoes := ds_alteracoes + chr(13) + 'Data Final: Mudou de ' + datetostr(objConvenio.dt_final) + ' para ' + datetostr(frmCadConvenioPgto.qyNfeConveniosEmpresasdt_final.AsDateTime);
      end;
      ...
      if objConvenio.sn_ativo <> frmCadConvenioPgto.qyNfeConveniosEmpresassn_ativo.AsInteger then
      begin
...
begin
   ...
   if sCaminho <> '' then
   begin
      TBlobField(frmCadConvenioPgto.qyNfeConveniosEmpresas.FieldByName('me_pdf')).SaveToFile( sCaminho );
   end;
end;
...
begin
   ...
   begin
      TBlobField(frmCadConvenioPgto.qyNfeConveniosEmpresas.FieldByName('me_pdf')).Clear;
      txtPDF.Text := '';
      frmCadConvenioPgto.qyNfeConveniosEmpresassn_ativo.AsInteger := 0;
...
begin
   ...
   begin
      frmCadConvenioPgto.qyNfeConveniosEmpresas.FieldByName('cd_pessoa').AsInteger := cd_pessoa;
...
begin
   try
      ...
      begin
         ...
         TBlobField(frmCadConvenioPgto.qyNfeConveniosEmpresas.FieldByName('me_pdf')).LoadFromFile(txtPDF.Text);

         frmCadConvenioPgto.qyNfeConveniosEmpresassn_ativo.AsInteger := 1;
         sn_atualiza_contrato := true;
      end;
...
begin
   if cd_pessoa <> 0  then
   begin
      if frmCadConvenioPgto.qyNfeConveniosEmpresas.State in [dsInsert] then
      begin
      ...
      frmCadConvenioPgto.qyNfeConveniosEmpresas.Post;
...
begin
   New(objConvenio);
   objConvenio.cd_pessoa   := frmCadConvenioPgto.qyNfeConveniosEmpresascd_convenio_pessoa.AsString;
   objConvenio.dt_inicial  := frmCadConvenioPgto.qyNfeConveniosEmpresasdt_inicial.AsDateTime;
   objConvenio.dt_final    := frmCadConvenioPgto.qyNfeConveniosEmpresasdt_final.AsDateTime;
   objConvenio.sn_ativo    := frmCadConvenioPgto.qyNfeConveniosEmpresassn_ativo.AsInteger;
end;
