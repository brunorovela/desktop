...
begin
   ...
   qryPlanosNegociacao.ParamByName('cd_coligada_matriz').AsInteger := DM.UsuarioLogado.ColigadaLogada;
end;
...
begin
   ...
   qryInsere.ParamByName('cd_coligada_matriz').AsInteger := DM.UsuarioLogado.ColigadaLogada;
   qryInsere.ExecSQL;
