...
//    tblResponsavel.Insert;
    ...
    Begin
       ...
       if pgPessoa.ActivePage = tsPai then begin
         ...
         iRespFinOld := tblPessoacd_resp_finan.AsInteger;
         ...
         if (DM.variavel_parametro('atualizar_responsavel_titulo') = 'S') then
            DM.atualizaResponsavelFinanc(tblPessoacd_pessoa.AsInteger, resultado_filtro.cd_pessoa, iRespFinOld);
...
{verifica se o pai é maior de idade}
    ...
    if pgPessoa.ActivePage = tsRespAcademico then
       ...
       if (DM.variavel_parametro('atualizar_responsavel_titulo') = 'S') AND (pgPessoa.ActivePage = tsRespFinanceiro) then
          DM.atualizaResponsavelFinanc(tblPessoacd_pessoa.AsInteger, tblPessoacd_pai.AsInteger, iRespFinOld);
    end;
    tblPessoa.Post;
...
begin
    ...
    if (DM.variavel_parametro('atualizar_responsavel_titulo') = 'S') AND (pgPessoa.ActivePage = tsRespFinanceiro) then
       DM.atualizaResponsavelFinanc(tblPessoacd_pessoa.AsInteger, tblPessoacd_mae.AsInteger, iRespFinOld);
