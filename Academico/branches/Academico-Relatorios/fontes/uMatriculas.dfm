object frmMatriculas: TfrmMatriculas
  ...
  object toolDisciplinas: TToolBar
    ...
    object ToolButton7: TToolButton
      Left = 504
      Top = 0
      Hint = 'Transfer'#234'ncia de Disciplina '
      AutoSize = True
      Caption = '&Transfer'#234'ncia de Disc.'
  ...
  object tblMatriculas: TUMZQuery
    Connection = DM.db
    SortedFields = 'Nome Asc;AnoSemestre Desc'
    SortType = stIgnored
    ...
    IndexFieldNames = 'Nome Asc;AnoSemestre Desc'
    SQLList.Strings = (
    ...
    object tblMatriculasDataEmissao: TDateTimeField
      Tag = 1
      DisplayLabel = 'Dt. da Matr'#237'cula'
      DisplayWidth = 10
      FieldName = 'dataemissao'
    ...
    object tblMatriculasds_departamento: TStringField
      Tag = 1
      DisplayLabel = 'Departamento'
      FieldName = 'ds_departamento'
      Size = 255
    end
    object tblMatriculasDS_CURSO: TStringField
      Tag = 1
      DisplayLabel = 'Nome do Curso'
      FieldName = 'DS_CURSO'
      Size = 255
    end
    object tblMatriculasCD_SITUACAO_CURSO: TLargeintField
      FieldName = 'CD_SITUACAO_CURSO'
    end
    object tblMatriculasCD_PESSOA_MATRICULOU: TIntegerField
      FieldName = 'CD_PESSOA_MATRICULOU'
    end
  ...
  object tblFichaIndividual: TUMZQuery
    ...
    SQL.Strings = (
      ...
      '   si.sn_final,'
      '   FichaIndividual.dt_base dt_base_ficha,'
      '   FichaIndividual.dt_inclusao dt_inclusao'
      'FROM'
      '   FichaIndividual'
    ...
    object tblFichaIndividualCodigo: TIntegerField
      Tag = 1
    ...
    object tblFichaIndividualdt_base_ficha: TDateTimeField
      DisplayLabel = 'Dt. Inclus'#227'o'
      DisplayWidth = 11
      FieldName = 'dt_base_ficha'
      DisplayFormat = 'dd/mm/yyyy'
    end
  ...
  object tblDoc: TUMZQuery
    ...
    SQL.Strings = (
      ...
      '   CASE '#9#9
      '      WHEN da.cd_conferencia = 1 then '#39'Conferido'#39' '
      '      WHEN da.cd_conferencia = 2 then '#39'Rejeitado'#39
      '      ELSE '#39'N'#227'o Conferido'#39
    ...
    object tblDocdt_conferencia: TDateField
      FieldName = 'dt_conferencia'
    end
    object tblDoccd_conferencia: TStringField
      FieldName = 'cd_conferencia'
    end
    object tblDocusuario_conferencia: TStringField
      FieldName = 'usuario_conferencia'
    end
  end
  ...
  object popOutrasAcoes: TPopupMenu
    ...
    object miHistorico: TMenuItem
      Caption = 'Hist'#243'rico Anterior do Estudante'
      OnClick = miHistoricoClick
    end
  end
  ...
  object qryTransfereFreqs: TUMZQuery
    ...
    SQLList.Strings = (
        ...
        #10'   daa.CD_PESSOA,'#13#10'   :CD_TURMA_NOVA,'#13#10'   :NR_ANOSEM_NOVO,'#13#10'   ' +
        'daa.CD_DISCIPLINA,'#13#10'   daa.CD_BIMESTRE,'#13#10'   daa.NR_AULA,'#13#10'   daa' +
        '.DS_FREQ'#13#10'FROM'#13#10'   DIARIO_AULAS_ALUNOS daa '#13#10'INNER JOIN diario_a' +
        'ulas da ON ('#13#10#9'da.anosemestre = daa.nr_anosem'#13#10#9'AND da.bimestre ' +
        '= daa.cd_bimestre'#13#10#9'AND daa.cd_disciplina = da.disciplina'#13#10#9'AND ' +
        'daa.cd_turma = da.turma'#13#10#9'AND daa.nr_aula = da.nro_aula'#13#10')'#13#10'WHER' +
        'E'#13#10'   da.`data` <= NOW() AND '#13#10'   daa.CD_PESSOA = :CD_PESSOA AND' +
        #13#10'   daa.CD_TURMA = :CD_TURMA AND'#13#10'   daa.NR_ANOSEM = :NR_ANOSEM' +
        ' AND'#13#10'   daa.cd_disciplina = :CD_DISCIPLINA')
    Left = 56
    Top = 397
  end
  object qryTransfereNotas: TUMZQuery
    ...
    SQLList.Strings = (
        ...
        ' CD_TURMA = :CD_TURMA AND'#13#10'   NR_ANOSEM = :NR_ANOSEM AND'#13#10'   CD_' +
