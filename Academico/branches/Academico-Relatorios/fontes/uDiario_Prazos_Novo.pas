...
type
  TfDiario_Prazos_Novo = class(TForm)
    ...
    qyPrazosCD_COLIGADA_MATRIZ: TIntegerField;
...
begin
   ...
   if qyPrazos.State = dsInsert then
   begin
      qyPrazosCD_COLIGADA_MATRIZ.AsInteger := DM.UsuarioLogado.GetColigadaLogada.Codigo;
   end;
...
begin
   ...
   qyPrazos.SQL.Add('         AND dp.cd_coligada_matriz = '+ IntToStr(DM.UsuarioLogado.GetColigadaLogada.Codigo));
