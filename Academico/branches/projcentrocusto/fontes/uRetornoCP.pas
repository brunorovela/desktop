...
begin
   ...
   qTitulo.SQL.Text :=
     ' SELECT cd_titulo, ds_despesa, nr_documento, cd_caixa, cd_forma_pgto, cd_situacao FROM fin_contas_pagar ' +
...
begin
   ...
   qConfig.SQL.Text :=
     ' SELECT cd_layout, ds_seg, nr_tit_ini, nr_tit_tam, nr_val_ini, nr_val_tam, nr_dat_ini, nr_dat_tam, ds_dat_formato, nr_oco_ini, nr_oco_tam, nr_oco_qtd ' +
...
begin
  ...
  qyArquivos.Close();
  qyArquivos.ParamByName('data1').AsString := FormatDateTime('yyyy-mm-dd', dtpInicio.Date) + ' 00:00:00';
  qyArquivos.ParamByName('data2').AsString := FormatDateTime('yyyy-mm-dd', dtpFim.Date) + ' 23:59:59';
  qyArquivos.Open();
end;
...
begin
   ...
   qItens.Close();
   qItens.SQL.Text :=
     ' INSERT INTO retorno_cp_itens (cd_retorno, nr_linha, me_linha, sn_baixado, vl_debito, dt_debito, cd_ocorrencia, ds_motivos, cd_titulo) ' +
     ' VALUES (:cd_retorno, :nr_linha, :me_linha, :sn_baixado, :vl_debito, :dt_debito, :cd_ocorrencia, :ds_motivos, :cd_titulo) ';
