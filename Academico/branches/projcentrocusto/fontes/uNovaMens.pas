...
type
  ...
  Tfrm_mensa_alterar = class(TForm)
    ...
    procedure dbValorDescontoEnter(Sender: TObject);
  ...
  private
    ...
    situacao         : integer;
    nossonumero      : string;
    vlr_bruto, vlr_desconto, vlr_desconto_extra, vlr_extra, vlr_juros, vlr_total, vlr_pago: Currency;
    Tipo_titulo  : Integer;
    plano_contas : Integer;
    centro_custos: Integer;
    chaveHistorico : String;
    sn_credito_parcela: String;
    alterouDataVencimento: Boolean;
...
begin
  ...
  CASE TabControl1.TabIndex of
     0 : Begin // Parcela Selecionada
            ...
            AtualizaMovimentoCR(DM.tblMensalidadescd_mensalidade_origem.AsInteger, curValorBruto + curValorExtra, curDescontoExtra);
               ...
               begin
                  ...
                  begin
                   ...
                   try
                      ...
                      AtualizaMovimentoCR(Dm.qAux1.FieldByName('cd_mensalidade_origem').AsInteger, curValorBruto + curValorExtra, curDescontoExtra);
                   except
                      Dm.qAux1.Cancel;
                   end;
...
procedure Tfrm_mensa_alterar.dbValorDescontoEnter(Sender: TObject);
begin
   AlteraValorEdicao(Sender);
end;
