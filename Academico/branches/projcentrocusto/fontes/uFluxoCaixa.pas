...
begin
   ...
   with qyValor do begin
      ...
      ParamByName('DtVencimento1').AsString := FormatDateTime('yyyy-mm-dd',dtpDataInicial.DateTime);
      ParamByName('DtVencimento2').AsString := FormatDateTime('yyyy-mm-dd',dtpDataFinal.DateTime);
   ...
   with qyValor do begin
      ...
      ParamByName('dt_inicial').AsString := FormatDateTime('yyyy-mm-dd',dtpDataInicial.DateTime);
      ParamByName('dt_final').AsString := FormatDateTime('yyyy-mm-dd',dtpDataFinal.DateTime);
   ...
   DataTemp := Trunc(dtpDataInicial.Date);

   while DataTemp <= Trunc(dtpDataFinal.Date) do begin
