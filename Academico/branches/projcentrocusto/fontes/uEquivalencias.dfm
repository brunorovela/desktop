object frmEquivalencias: TfrmEquivalencias
  ...
  object ToolBar1: TToolBar
    ...
    object btnEliminarEquivalencia: TToolButton
      ...
      Top = 0
      AutoSize = True
      Caption = 'Eliminar Eq'#252'ival'#234'ncia'
  ...
  object tblEquiv: TUMZQuery
    ...
    SQL.Strings = (
        ...
        'Select Equivalencias.*, Disciplinas.Descricao  From Equivalencia' +
        's, Disciplinas'
      'WHERE Equivalencias.Disciplina = Disciplinas.codigo  '
      'AND Equivalencias.Curso = Disciplinas.Curso'
      'AND Equivalencias.CodigoAluno = :CodigoAluno'
      'AND Equivalencias.Curso IN (:CURSO, :cd_curso)'
      'ORDER BY Equivalencias.id_equivalencia')
    Params = <
      item
        DataType = ftInteger
        Name = 'CodigoAluno'
  ...
  object tblDiscEquiv: TUMZQuery
    ...
    object tblDiscEquivEq_Disciplina: TStringField
      DisplayLabel = 'Disciplina'
      FieldName = 'Eq_Disciplina'
      Origin = 'WMESTRE12.EquivalenciasDisciplinas.Eq_Disciplina'
      Size = 100
    end
