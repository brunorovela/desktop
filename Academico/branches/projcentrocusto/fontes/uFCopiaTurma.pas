...
type
  ...
  public
    { Public declarations }
    procedure carregarTela(const cd_coligada, cd_coligada_atual: Integer; const coligadas, cd_curso: String; const nr_anosemestre: Integer);
  end;
...
procedure TfCopiaTurma.carregarTela(const cd_coligada, cd_coligada_atual: Integer; const coligadas, cd_curso: String; const nr_anosemestre: Integer);
begin
   Curso := cd_curso;
      ...
      begin
         ...
         begin
            ...
            begin
               ...
               CopiaTurmaEntreColigadas(
                  cd_turma_antiga, cd_turma_nova, AnoSemestre, nr_anosemestre,
                  TUMCheckBoxObj( pnCentro.Components[I] ).Coligada, cd_coligada_nova
               );

               if ( CopiarDisciplinasTurmasProfessor ) then
                  CopiarDisciplinasTurmasProfessorEntreColigadas(
                     TItemCombo(TUMCheckBoxObj( pnCentro.Components[I] ).Objeto).getCodigo(), cd_turma_nova,
                     AnoSemestre, nr_anosemestre,
                     Coligada
                  );
...
begin
   ...
   begin
      ...
      campos :=
         ...
         ' sn_terminal_acesso, cd_caixa, cd_coligada, nr_min_alunos, ' +
      ...
      campos :=
         ...
         ' professor_responsavel, sn_inscricao_online, cd_avaliacao, ' +
         ' vl_ordem, cd_campus, cd_proxima_turma, cd_centro, ' +
         ' sn_terminal_acesso, cd_caixa, :cd_coligada_nova, nr_min_alunos, ' +
         ' cd_grade, sn_bloquear_disc_pendentes, cd_etapa_mec, ' +
