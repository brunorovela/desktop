...
type
   TfRegistraEliminEqui = class(TForm)
      ...
      qryLogEquivalenciasNM_DISCIPLINA_EQ: TStringField;
      ...
      qryEquivalenciaEQ_DISCIPLINA: TStringField;
...
begin
   ...
   begin
      ...
      qEliminaEquiv.ParamByName('CURSO').AsString := qryCursoCD_CURSO.AsString;
