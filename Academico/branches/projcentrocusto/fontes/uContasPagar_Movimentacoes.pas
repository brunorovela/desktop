...
begin
   ...
   Case qyMovimentacoescd_tipo_acao.AsInteger of
      ...
      2, 3 : begin  // Baixa Por Cancelamento ou Desconto

           if Mensagem('Tem certeza que deseja desfazer a ação de movimento?', 'Atenção', MB_YESNOCANCEL + MB_ICONQUESTION, Handle) <> mrYES then begin
              Exit;
           end;
