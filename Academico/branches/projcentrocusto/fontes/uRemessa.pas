...
uses
   General, uDM, Main, uSplash, StrUtils, uGerarRemessa, uUsuario;
...
begin
   ...
   with qyAux do begin
      ...
      Params.Clear();
      SQL.Add(''+
      'SELECT CD_LAYOUT, NM_LAYOUT, NR_REMESSA FROM REM_LAYOUTS WHERE SN_ATIVO = 1 AND ( cd_origem = 1 or cd_origem = 3) ORDER BY NM_LAYOUT'+
      '');
      Open();
   ...
   begin
      ...
      cbListaLayouts.AddItem('Todos', nil );
   end;


end;

procedure TfrmRemessa.FiltraDados();
const
...
begin
   ...
   try
      ...
      begin
         ...
         AddParam('DT_ACAO_MENOR', formatdatetime('yyyy-mm-dd 00:00:01', dtFiltroInicio.DateTime) );
         AddParam('DT_ACAO_MAIOR', formatdatetime('yyyy-mm-dd 23:59:59', dtFiltroFim.DateTime ) );
      end;
...
begin
   if ( dtFiltroInicio.Date > dtFiltroFim.Date) then begin
