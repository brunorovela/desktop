...
uses
  ...
  ZSqlUpdate, ImgList, StrUtils, uBuscaCentro, uCentroCusto, uItemCombo;
...
type
   ...
   public
    ...
    procedure baixarCompromisso(cd_caixa_sel: Integer; valor: Currency; valor_multa: Currency; dataProvavelPgto: String);
...
procedure TfrmCompromissoCadastro.baixarCompromisso(cd_caixa_sel: Integer; valor: Currency; valor_multa: Currency; dataProvavelPgto: String);
CONST
   SQL_DISPONIBILIDADE = '' +
   'SELECT                                      '+
   '  CP.CD_TIPO_TITULO,                        '+
...
begin
   ...
   cd_coligada_contas_pagar := uContasPagar_Planilha.frm_Compromisso_Planilha.qryContasPagarCD_COLIGADA.AsInteger;
   ...
   Movimento.RegistrarMovimentacaoCP(CodMovimento, dataProvavelPgto);
...
begin
   ...
   begin
      ...
      begin
         ...
         begin
            Self.baixarCompromisso(cd_caixa_sel, valor, valor_multa, dataProvavelPgto);
...
//      if (cmbCentroCusto.Items.Count-1) = 0 then
//      begin
//         cmbCentroCusto.ItemIndex := 0;
//      end;
...
var
   ...
   sDig4    : string;
begin
   sGrupo1 := copy(txtParBoletoCodigoBarrasArrecadacao.Text, 1, 11);
   sGrupo2 := copy(txtParBoletoCodigoBarrasArrecadacao.Text, 12, 11);
   sGrupo3 := copy(txtParBoletoCodigoBarrasArrecadacao.Text, 23, 11);
   sGrupo4 := copy(txtParBoletoCodigoBarrasArrecadacao.Text, 34, 11);
   ...
   txtGrupo1.Text := sGrupo1;
   txtGrupo3.Text := sGrupo2;
   txtGrupo5.Text := sGrupo3;
   txtGrupo7.Text := sGrupo4;

   txtGrupo2.Text := sDig1;
   txtGrupo4.Text := sDig2;
   txtGrupo6.Text := sDig3;
   txtGrupo8.Text := sDig4;
end;
...
//                  if trim(txtDsHistorico.Text) = '' then
//                  begin
...
//                  end;
               ...
               begin
                  bAlteraPlanoContas := false;
                  txtCdConta.Text := cd_plano_contas_inicial;
                  Self.SelecionaPlanoConta( cd_plano_contas_inicial );
               end;
            end;
         end
         else
