...
type
  TfMensalidadeGerar = class(TForm)
    ...
    procedure dtpVenctoChange(Sender: TObject);
...
begin
   ...
   begin
      ...
      if qryTiposTituloVL_PADRAO.AsCurrency > 0 then
      begin
...
procedure TfMensalidadeGerar.dtpVenctoChange(Sender: TObject);
begin
   cdsTituloDT_VENCTO.AsDateTime := dtpVencto.Date;
end;
...
var
   Credito: Char;  
   MensDataBaixa, Chave, Obs, NossoNumero, Turma: string;
   Ano, Mes, Dia, DiaAux: Word;
   I, Codigo, Depto, cd_coligada: Integer;
   PodeIncluir: Boolean;
   Stmt, Statement: IZPreparedStatement;
   ResultSet: IZResultSet;
   Movimento: TMovimento;
      ...
      begin
         ...
         begin
            ...
            Codigo := DM.GerarMensalidade(
               ...
               cdsTituloVL_BRUTO.AsCurrency, 0, qrySelecaoANOSEMESTRE.AsInteger,
...
begin
   ...
   begin
      Result := False;
      dtpVencto.Color := clInfoBk;
   end
   else
      dtpVencto.Color := clWindow;
