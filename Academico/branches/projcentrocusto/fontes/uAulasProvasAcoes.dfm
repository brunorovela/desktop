object frmAulasProvasAcoes: TfrmAulasProvasAcoes
  ...
  object pcAulas: TPageControl
    ...
    Width = 824
    Height = 683
    ActivePage = tsCronogramasGerenciar
    Align = alClient
    MultiLine = True
    ...
    object tsAulas: TTabSheet
      ...
      object Panel1: TPanel
        ...
        object dtDataInic: TDateTimePicker
          Left = 137
          Top = 61
          Width = 81
          Height = 21
        ...
        object dtDataFin: TDateTimePicker
          Left = 246
          Top = 60
          Width = 86
          Height = 21
    ...
    object tsFrequencia: TTabSheet
      ...
      object cbAtualizaFI: TCheckBox
        Left = 176
        Top = 103
        Width = 273
        Height = 17
        Caption = 'Atualizar tamb'#233'm Di'#225'rio de classe e Ficha Individual'
        TabOrder = 2
      end
      object cbFreqForca: TCheckBox
        Left = 176
        Top = 79
        Width = 361
        Height = 17
        Caption = 
          'For'#231'ar rec'#225'lculo (executar tamb'#233'm sobre os registros j'#225' processa' +
          'dos)'
        TabOrder = 1
      end
      object Memo1: TMemo
        ...
        Lines.Strings = (
          'ATEN'#199#195'O!!!'
          ''
          'Se a op'#231#227'o "For'#231'ar rec'#225'lculo" for utilizada, '
          'o hist'#243'rico de frequ'#234'ncia do aluno pode ser alterado.'
          ''
          'Certifique-se de que o Filtro adotado '#233' o desejado.')
        TabOrder = 3
      end
    end
    ...
    object tsCronogramasGerenciar: TTabSheet
      ...
      object dtpCronogramasData: TDateTimePicker
        Left = 668
        Top = 272
        Width = 81
        Height = 21
      ...
      object pnPrimeiraAula: TPanel
        ...
        object dtpDataAula1: TDateTimePicker
          Left = 142
          Top = 21
          Width = 83
          Height = 21
          Date = 40605.628730196760000000
          Time = 40605.628730196760000000
          TabOrder = 0
        ...
        object dtpDataAula2: TDateTimePicker
          Left = 142
          Top = 56
          Width = 83
          Height = 21
        ...
        object dtAvaliacao: TDateTimePicker
          Left = 518
          Top = 56
          Width = 81
          Height = 21
          Date = 41066.443696782410000000
          Time = 41066.443696782410000000
          TabOrder = 6
        end
      end
      object Panel4: TPanel
        ...
        object ckbCriaProvaUltimaAula: TCheckBox
          ...
          Width = 144
          Height = 17
          Caption = 'Criar prova na '#250'ltima aula'
          TabOrder = 8
        end
      ...
      object Panel5: TPanel
        ...
        object dtpDtInicioDiario: TDateTimePicker
          Left = 114
          Top = 6
          Width = 79
          Height = 21
          Date = 40718.396035520830000000
          Time = 40718.396035520830000000
          TabOrder = 0
          OnChange = dtpDtInicioDiarioChange
        end
        object dtpDtFimDiario: TDateTimePicker
          Left = 327
          Top = 6
          Width = 81
          Height = 21
          Date = 40718.396137604170000000
          Time = 40718.396137604170000000
          TabOrder = 1
          OnChange = dtpDtFimDiarioChange
        end
      end
