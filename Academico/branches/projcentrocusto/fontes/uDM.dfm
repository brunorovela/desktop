object DM: TDM
  ...
  object tblGrade: TUMZQuery
    ...
    object tblGradeAnoSemestre: TSmallintField
      FieldName = 'AnoSemestre'
  ...
  object qryInsert: TUMZQuery
    ...
    SQLList.Strings = (
        ...
        'mysql-5=insert into Mensalidades'#13#10'(CodigoAluno, cd_resp, Parcela' +
        ', DataVencimento, dt_competencia, Turma, DataEmissao, NossoNumer' +
        'o, '#13#10'ValorBruto, ValorDesconto, DescontoExtra, ValorExtra, Valor' +
        'Total, ValorJuros, valorjuros_fixo,  '#13#10'ValorPago, DataPagamento,' +
        ' Situacao, Usuario, Bloqueto, '#13#10'AnoSemestre, DataBaseCorrecao, I' +
        'ndiceCorrecao, Curso, Depto, TipoParcela, sn_credito_parcela, cd' +
        '_mensalidade_origem, nr_creditos,'#13#10'ds_historico, cd_tipo_titulo,' +
        ' cd_plano_conta, cd_centro_custo, cd_caixa, vl_credito, cd_item_' +
        'plano, cd_cheque_devolvido, cd_coligada, SN_NFE_GERADA, NR_NF, '#13 +
        #10'ds_autentica_impressao, VL_PERCENTUAL_DIVISAO, cd_desc_condicio' +
        'nal, ds_obs_desc'#13#10')'#13#10'VALUES'#13#10'('#13#10':CodigoAluno,  :cd_resp, :Parcel' +
        'a, :DataVencimento, :dt_competencia, :Turma, :DataEmissao,'#13#10':Nos' +
        'soNumero, :ValorBruto, :ValorDesconto, :DescontoExtra, :ValorExt' +
        'ra,'#13#10':ValorTotal, :ValorJuros, :valorjuros_fixo, :ValorPago, :Da' +
        'taPagamento, :Situacao,'#13#10':Usuario, :Bloqueto, :AnoSemestre, '#13#10':D' +
        'ataBaseCorrecao, :IndiceCorrecao, :Curso, :Depto, :Tipo, :sn_cre' +
        'dito_parcela, :cd_mensalidade_origem, :nr_creditos,'#13#10':ds_histori' +
        'co, :cd_tipo_titulo, :cd_plano_conta, :cd_centro_custo, :cd_caix' +
        'a, :ValorCredito, :CodItemPlano, :cd_cheque_devolvido, :cd_colig' +
        'ada, :SN_NFE_GERADA, :NR_NF,'#13#10':ds_autentica_impressao, :VL_PERCE' +
        'NTUAL_DIVISAO, :cd_desc_condicional, :ds_obs_desc'#13#10')'
      
        'oracle=insert into Mensalidades'#13#10'(CodigoAluno, cd_resp, Parcela,' +
        ' DataVencimento, dt_competencia, Turma, DataEmissao, NossoNumero' +
        ', '#13#10'ValorBruto, ValorDesconto, DescontoExtra, ValorExtra, ValorT' +
        'otal, ValorJuros, valorjuros_fixo,  '#13#10'ValorPago, DataPagamento, ' +
        'Situacao, Usuario, Bloqueto, '#13#10'AnoSemestre, DataBaseCorrecao, In' +
        'diceCorrecao, Curso, Depto, TipoParcela, sn_credito_parcela, cd_' +
        'mensalidade_origem, nr_creditos,'#13#10'ds_historico, cd_tipo_titulo, ' +
        'cd_plano_conta, cd_centro_custo, cd_caixa, vl_credito, cd_item_p' +
        'lano, cd_cheque_devolvido, cd_coligada, SN_NFE_GERADA, NR_NF, VL' +
        '_PERCENTUAL_DIVISAO, cd_desc_condicional, ds_obs_desc'#13#10')'#13#10'VALUES' +
        #13#10'('#13#10':CodigoAluno,  :cd_resp, :Parcela, TO_DATE(:DataVencimento,' +
        ' '#39'YYYY-MM-DD'#39'), TO_DATE(:dt_competencia, '#39'YYYY-MM-DD'#39'), :Turma, ' +
        'TO_DATE(:DataEmissao, '#39'YYYY-MM-DD'#39'),'#13#10':NossoNumero, :ValorBruto,' +
        ' :ValorDesconto, :DescontoExtra, :ValorExtra,'#13#10':ValorTotal, :Val' +
        'orJuros, :valorjuros_fixo, :ValorPago, :DataPagamento, :Situacao' +
        ','#13#10':Usuario, :Bloqueto, :AnoSemestre, '#13#10'TO_DATE(:DataBaseCorreca' +
        'o, '#39'YYYY-MM-DD'#39'), :IndiceCorrecao, :Curso, :Depto, :Tipo, :sn_cr' +
        'edito_parcela, :cd_mensalidade_origem, :nr_creditos,'#13#10':ds_histor' +
        'ico, :cd_tipo_titulo, :cd_plano_conta, :cd_centro_custo, :cd_cai' +
        'xa, :ValorCredito, :CodItemPlano, :cd_cheque_devolvido, :cd_coli' +
        'gada, :SN_NFE_GERADA, :NR_NF, :VL_PERCENTUAL_DIVISAO, :cd_desc_c' +
        'ondicional, :ds_obs_desc'#13#10')')
    Left = 192
    Top = 310
    ParamData = <
      item
  ...
  object qryInsertHist: TUMZReadOnlyQuery
    ...
    SQLList.Strings = (
        ...
        ' CD_INSTITUICAO)'#13#10'VALUES'#13#10'   (:CODIGOALUNO, :GRAU, :SERIE, :ANO,' +
        ' :DS_ESCOLA, :DS_CIDADE, :DS_ESTADO, :CD_INSTITUICAO)')
    Left = 448
    Top = 56
    ParamData = <
      item
  ...
  object qryUpdFreqA: TUMZQuery
    ...
    SQL.Strings = (
      ...
      'SET'
        ...
        '   F.FREQUENCIA = ROUND(100 - (F.TOTALFALTAS / T.NUMEROAULAS * 1' +
        '00 ), 0)'
      'WHERE'
      '   F.SN_BLOQ_FREQ_GLOBAL = 0 AND'
      '   F.TURMA = T.TURMA AND'
      '   F.ANOSEMESTRE = T.ANOSEMESTRE AND'
      '   F.DISCIPLINA = T.DISCIPLINA AND'
      '   F.CODIGOALUNO = :CODIGOALUNO AND'
      '   F.TURMA = :TURMA AND'
      '   F.ANOSEMESTRE = :ANOSEMESTRE')
    Params = <
    ...
    SQLList.Strings = (
        ...
        'mysql-5=UPDATE'#13#10'   FICHAINDIVIDUAL F,'#13#10'   TURMASPROFESSORES T'#13#10'S' +
        'ET'#13#10'   F.FREQUENCIA = ROUND(100 - (F.TOTALFALTAS / T.NUMEROAULAS' +
        ' * 100 ), 0)'#13#10'WHERE'#13#10'   F.SN_BLOQ_FREQ_GLOBAL = 0 AND'#13#10'   F.TURM' +
        'A = T.TURMA AND'#13#10'   F.ANOSEMESTRE = T.ANOSEMESTRE AND'#13#10'   F.DISC' +
        'IPLINA = T.DISCIPLINA AND'#13#10'   F.CODIGOALUNO = :CODIGOALUNO AND'#13#10 +
        '   F.TURMA = :TURMA AND'#13#10'   F.ANOSEMESTRE = :ANOSEMESTRE'
      
        'oracle=MERGE INTO FICHAINDIVIDUAL F USING'#13#10'('#13#10'   SELECT'#13#10'      T' +
        'URMA,'#13#10'      ANOSEMESTRE,'#13#10'      DISCIPLINA,'#13#10'      NUMEROAULAS'#13 +
        #10'   FROM'#13#10'      TURMASPROFESSORES'#13#10'   WHERE'#13#10'      TURMA = :TURM' +
        'A AND'#13#10'      ANOSEMESTRE = :ANOSEMESTRE'#13#10') UP ON'#13#10'   (F.SN_BLOQ_' +
        'FREQ_GLOBAL = 0 AND'#13#10'    F.TURMA = UP.TURMA AND'#13#10'    F.ANOSEMEST' +
        'RE = UP.ANOSEMESTRE AND'#13#10'    F.DISCIPLINA = UP.DISCIPLINA AND'#13#10' ' +
        '   F.CODIGOALUNO = :CODIGOALUNO)'#13#10'WHEN MATCHED THEN'#13#10'   UPDATE S' +
        'ET'#13#10'      F.FREQUENCIA = ROUND(100 - (F.TOTALFALTAS / UP.NUMEROA' +
        'ULAS * 100 ), 0)')
    Left = 464
    Top = 432
    ParamData = <
