...
begin
   ...
   DM.setLog(1006, 'Exclusao', tblDeptosCodigo.AsString, qyColigadacd_coligada.AsInteger, tblDeptosDescricao.AsString);
end;
...
begin
   ...
   if tblDeptos.State = dsInsert then begin
      DM.setLog(1006, 'Inclusao', tblDeptosCodigo.AsString, qyColigadacd_coligada.AsInteger, tblDeptosDescricao.AsString);
   end else begin
      DM.setLog(1006, 'Alteracao', tblDeptosCodigo.AsString, qyColigadacd_coligada.AsInteger, tblDeptosDescricao.AsString);
   end;
