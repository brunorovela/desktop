...
begin
   ...
   { TODO -cImplementação -oJosimar Zimermann : Codificar a exportação dos dados para arquivo XML }
end;
...
begin
   ...
   { TODO -cImplementação -oJosimar Zimermann : Codificar rotina para salvar o conteúdo para exportação no documento XML }
