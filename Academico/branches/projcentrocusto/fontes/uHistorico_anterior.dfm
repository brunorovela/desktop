object frm_historico_anterior: Tfrm_historico_anterior
  ...
  object tblColegiosSeries: TUMZQuery
    ...
    SQL.Strings = (
      'select * from historico_escolas_series where '
  ...
  object qryInsertFicha: TUMZQuery
    ...
    SQL.Strings = (
      ...
      #9#39#39' CODIGOGRADE'
      'FROM'
      #9'matriculas_curso mc'
      
        #9'INNER JOIN GRADES G ON (G.cd_grade= mc.cd_grade AND G.CD_CURSO ' +
        '= MC.CD_CURSO)'
      ...
      'WHERE'
        ...
        '  '#9'mc.cd_matricula_curso = :cd_matricula_curso AND nr_serie = :n' +
        'r_serie')
    Params = <
      item
        DataType = ftUnknown
