...
begin
   ...
   qryPreparacao.ParamByName('DT_INICIAL').AsDateTime := dtpDataInicial.DateTime;
   qryPreparacao.ParamByName('DT_FINAL').AsDateTime := dtpDataFinal.DateTime;
...
procedure Tfrm_Compromisso_Preparados.dtpDataInicialChange(
  Sender: TObject);
begin
   filtra
end;

procedure Tfrm_Compromisso_Preparados.dtpDataFinalChange(Sender: TObject);
begin
   filtra
end;
