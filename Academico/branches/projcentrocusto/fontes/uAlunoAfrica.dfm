inherited fAlunosAfrica: TfAlunosAfrica
    ...
    inherited tsDadosPessoais: TTabSheet
      ...
      inherited pcDocumentos: TPageControl
        inherited TabSheet2: TTabSheet
          ...
          ExplicitWidth = 753
          ExplicitHeight = 37
          inherited dbedExpiracao: TDBEdit
            Top = 19
            ExplicitTop = 19
          end
        end
  ...
  object tblResponsavel: TUMZQuery [25]
    Connection = DM.db
  ...
  object dsResponsavel: TDataSource [26]
    DataSet = tblResponsavel
    OnStateChange = dsResponsavelStateChange
    Left = 456
    Top = 65532
  end
  object dsContatoResponsavel: TDataSource [27]
    DataSet = tblContatoResponsavel
    Left = 397
    Top = 65531
  end
  object tblMatriculaCurso: TUMZQuery [28]
    Connection = DM.db
    SQL.Strings = (
  ...
  object dsMatriculasCurso: TDataSource [29]
    AutoEdit = False
    DataSet = tblMatriculaCurso
    Left = 748
    Top = 292
  end
  object tblMatriculasEtapa: TUMZQuery [30]
    Connection = DM.db
    SQL.Strings = (
  ...
  object dsMatriculasEtapa: TDataSource [31]
    AutoEdit = False
    DataSet = tblMatriculasEtapa
    Left = 749
    Top = 324
  end
  object qryMensalidades: TUMZQuery [32]
    Connection = DM.db
    SQL.Strings = (
  ...
  object tblContatosPadroes: TUMZQuery [33]
    Connection = DM.db
    Params = <>
    Left = 608
    Top = 104
  end
  object tblContatos: TUMZQuery [34]
    Connection = DM.db
    Params = <>
    Left = 640
    Top = 104
  end
  object qyDocumentos: TUMZQuery [35]
    Connection = DM.db
    SQL.Strings = (
      'SELECT'
  ...
  object qyDocumentosNaoNecessarios: TUMZQuery [36]
    Connection = DM.db
    SQL.Strings = (
      'SELECT'
      #9'COUNT(da.apresentou) AS qtde'
  ...
  object popContatoResp: TPopupMenu [37]
    Left = 748
    Top = 356
  ...
  object tblContatoResponsavel: TUMZQuery [38]
    Connection = DM.db
