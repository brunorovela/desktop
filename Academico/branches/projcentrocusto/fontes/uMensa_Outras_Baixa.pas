...
uses uClassMovimento, uDM, uUsuario;
...
//   end;
   ...
   begin
      qyAlunos.SQL.Add(
         ' SELECT                ' +
         '   m.cd_mensalidade_origem,                                ' +
         '   FIRST_OCCURRENCE(m.cd_mensalidade) cd_mensalidade, m.cd_coligada, FIRST_OCCURRENCE(m.valorjuros) valorjuros, ' +
      ...
      qyAlunos.SQL.Add(
         ' SELECT                ' +
         '   m.cd_mensalidade_origem,                                ' +
         '   m.cd_mensalidade, m.cd_coligada, m.valorjuros,          ' +
         '   (SUM(f.vl_entrada) - Sum(f.vl_saida)) Pendente          ' +
         ' FROM                                                      ' +
         '   mensalidades m INNER JOIN pessoas p ON (m.codigoaluno = p.cd_pessoa)       ' +
         '   LEFT JOIN fin_mov_cr f ON (m.cd_mensalidade_origem = f.cd_mensalidade)     ' +
