...
uses uDM, uFComprasBuscaProdutos, General, uCadEmpresas, uUsuario,
  ClassPessoas, uFSelecionarPessoa;
...
begin
   ...
   begin
      frmComprasBuscaProdutos.Filtrar( qyRegistraEntradacd_produto.AsString, True );
   end;
...
procedure TfrmComprasRegistroEntradas.qyRegistraEntradaBeforePost(
  DataSet: TDataSet);
begin
   qyRegistraEntradadt_compra.AsDateTime := dtpDtCompra.DateTime;
