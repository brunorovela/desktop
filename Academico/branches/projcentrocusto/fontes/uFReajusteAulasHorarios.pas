...
type
   ...
   strict private
      ...
      procedure ZerarGrid();
      function CarregarGrid(ListaExecucao : TListaExecucao; const nr_anosemestre: Integer; cd_turma: String; const dataInicio: TDateTime = 0): Boolean;
   ...
   public
      ...
      class function ajustarAulasHoras(var ListaExecucao: TListaExecucao; ListaHorariosDasDisciplinas: TStringList; const nr_anosemestre: Integer; const cd_turma_base: String; const dataInicio: TDateTime = 0): Boolean;
   end;
...
class function TfrmReajusteAulasTurma.ajustarAulasHoras(
  ...
  const dataInicio: TDateTime): Boolean;
var
...
begin
   ...
   if NOT(frmReajusteAulasTurma.CarregarGrid(ListaExecucao, nr_anosemestre, cd_turma_base, dataInicio)) then
   begin
         ...
         begin
            ...
            case StrToIntDef(acaoRegistro.getDescricao(), 0) of
               ...
               2: begin
                  ...
                  ExecucaoInsereVinculoHorario := TExecucaoVinculoAula.Create(StrToInt(acaoRegistro.getCodigo()), cd_horario_turma);
...
const
   SQL_GET_AULAS_INCORRETAS =
      ...
      '         da.anosemestre = thc.nr_anosemestre AND da.turma = thc.cd_turma_base AND ' +
      '         DAYOFWEEK(da.`data`) = thc.nr_dia_semana AND da.disciplina = thc.cd_disciplina ' +
      '      ) ' +
...
begin
   ...
   qyGetListaAulas.SQL.Add('AND thc.sn_ativo = 1 AND ( 0=1');
   ...
   begin
      ...
      begin
         ...
         begin
            qyGetListaAulas.SQL.Add(Format('OR ( thc.cd_disciplina = %d AND DAYOFWEEK(da.`data`) = %d )', [ExecucaoHorarioTurma.Disciplina.Codigo, ExecucaoHorarioTurma.DiaSemana] ) );
         end;
      end;
   end;
