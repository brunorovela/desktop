...
uses
  ...
  General, uFiltroControleCartao, uEstornarCartao;
...
type
  ...
  TfrmControleCartao = class(TForm)
    ...
    procedure qyControleCartaovalor_liquidoGetText(Sender: TField;
      var Text: string; DisplayText: Boolean);
    procedure qyControleCartaovl_parcelaGetText(Sender: TField;
      var Text: string; DisplayText: Boolean);
    procedure qyControleCartaotarifaGetText(Sender: TField; var Text: string;
      DisplayText: Boolean);
    procedure qyControleCartaonr_taxaGetText(Sender: TField; var Text: string;
      DisplayText: Boolean);
...
begin
   ...
   begin
      ...
      begin
         ...
         cdOperacao := cdsControleCartaocd_operacao.AsInteger;
   ...
   frmLiquidar.cdOperacao := cdOperacao;
...
begin
   ...
   begin
      Mensagem(
         'Você não pode alterar uma parcela de uma operação que já tenha alguma parcela liquidada.',
         'Aviso',
         MB_OK  + MB_ICONWARNING
      );
   ...
   {VALIDA SELECIONOU UM REGISTRO LIQUIDADO}
end;
...
procedure TfrmControleCartao.qyControleCartaonr_taxaGetText(Sender: TField;
  var Text: string; DisplayText: Boolean);
begin
   Text := FormatFloat('#,,0.00', Sender.AsCurrency) + '%';
end;

procedure TfrmControleCartao.qyControleCartaotarifaGetText(Sender: TField;
  var Text: string; DisplayText: Boolean);
begin
   Text := 'R$ ' + FormatFloat('#,,0.00', Sender.AsCurrency);
end;

procedure TfrmControleCartao.qyControleCartaovalor_liquidoGetText(
  Sender: TField; var Text: string; DisplayText: Boolean);
begin
   Text := 'R$ ' + FormatFloat('#,,0.00', Sender.AsCurrency);
end;

procedure TfrmControleCartao.qyControleCartaovl_parcelaGetText(Sender: TField;
  var Text: string; DisplayText: Boolean);
begin
   Text := 'R$ ' + FormatFloat('#,,0.00', Sender.AsCurrency);
end;
