object frmProfessores: TfrmProfessores
      ...
      object DBGrid1: TDBGrid
        ...
        Columns = <
          ...
          item
            ...
            Title.Caption = 'Unidades de Ensino'
            Width = 500
            Visible = True
          end>
      end
  ...
  object tblProfessores: TUMZQuery
    Connection = DM.db
    OnCalcFields = tblProfessoresCalcFields
    ...
    SQL.Strings = (
      ...
      #9'prof.cd_titulacao,'
      #9'prof.cd_area,'
      #9'GROUP_CONCAT(pu.cd_coligada) AS lista_coligadas_professor,'
      '  GROUP_CONCAT(C.nm_coligada SEPARATOR '#39' ; '#39') AS coligadas'
      'FROM'
      #9'professores prof'
      'INNER JOIN professores_unidades pu ON ('
      #9'pu.cd_professor = prof.cd_pessoa'
      ')'
      'INNER JOIN coligadas c ON ('
      #9'c.cd_coligada = pu.cd_coligada'
      ')'
      'INNER JOIN pessoas p ON (p.cd_pessoa = prof.cd_pessoa)'
      'WHERE'
      #9'pu.sn_professor = 1'
      #9'and c.CD_COLIGADA_MATRIZ = 1'
    ...
    object tblProfessoreslista_coligadas_professor: TMemoField
      FieldName = 'lista_coligadas_professor'
      BlobType = ftMemo
    end
    object tblProfessorescoligadas: TStringField
  ...
  object tblTurmasProfessores: TUMZQuery
    ...
    SQL.Strings = (
        ...
        'Select COALESCE(cd_sala, -1) AS cd_sala, * From TurmasProfessore' +
        's '
      'where '
      'Professor = :cd_pessoa and'
      'AnoSemestre = :AnoSemestre'
      'Order By AnoSemestre,Turma,Disciplina,Professor')
    Params = <
      item
        DataType = ftInteger
        Name = 'cd_pessoa'
    ...
    object tblTurmasProfessorescreditosAcademicos: TFloatField
      FieldName = 'creditosAcademicos'
    end
  end
  ...
  object ImageList1: TImageList
    ...
    Bitmap = {
      ...
      
      000000000000}
  end
