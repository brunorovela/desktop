...
type
   TfNFSeCad = class(TFrame)
      ...
      dtpEnvioIni: TDateTimePicker;
      lblDataEnvioAte: TLabel;
      dtpEnvioFim: TDateTimePicker;
...
begin
   dtpEnvioIni.Enabled := chkDataEnvioDe.Checked;
   dtpEnvioFim.Enabled := chkDataEnvioDe.Checked;
...
begin
   ...
   begin
      ...
      Filtro := Filtro + Format(SFiltroDataEnvio,
         [QuotedStr(FormatDateTime(SDateTimeFormat, dtpEnvioIni.Date)),
          QuotedStr(FormatDateTime(SDateTimeFormat, dtpEnvioFim.Date))]);
   end;
