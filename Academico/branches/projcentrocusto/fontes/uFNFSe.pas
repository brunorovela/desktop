...
type
   TfNFSe = class(TForm)
      ...
      dtpDataEnvioDe: TDateTimePicker;
      dtpDataEnvioAte: TDateTimePicker;
      ...
      dtpDataVenctoDe: TDateTimePicker;
      dtpDataVenctoAte: TDateTimePicker;
      lblDataVenctoAte: TLabel;
      chkDataPagto: TCheckBox;
      dtpDataPagtoDe: TDateTimePicker;
      lblDataPagtoAte: TLabel;
      dtpDataPagtoAte: TDateTimePicker;
      chkDataComp: TCheckBox;
      dtpDataCompDe: TDateTimePicker;
      lblDataCompAte: TLabel;
      dtpDataCompAte: TDateTimePicker;
      pnlResumo: TPanel;
      gbResumo: TGroupBox;
...
begin
   PodeTrocar := true;
   dtpDataVenctoDe.Date := Now;
   dtpDataVenctoAte.Date := Now;
   dtpDataPagtoDe.Date := Now;
   dtpDataPagtoAte.Date := Now;
   dtpDataCompDe.Date := Now;
   dtpDataCompAte.Date := Now;
...
begin
   dtpDataCompDe.Enabled := chkDataComp.Checked;
   dtpDataCompAte.Enabled := chkDataComp.Checked;
...
begin
   dtpDataEnvioDe.Enabled := chkDataEnvioDe.Checked;
   dtpDataEnvioAte.Enabled := chkDataEnvioDe.Checked;
   lblDataEnvioAte.Enabled := chkDataEnvioDe.Checked;
end;

procedure TfNFSe.chkDataPagtoClick(Sender: TObject);
begin
   dtpDataPagtoDe.Enabled := chkDataPagto.Checked;
   dtpDataPagtoAte.Enabled := chkDataPagto.Checked;
...
begin
   dtpDataVenctoDe.Enabled := chkDataVencto.Checked;
   dtpDataVenctoAte.Enabled := chkDataVencto.Checked;
...
begin
   ...
   CarregaTiposTitulo;
   CarregaDeptos;
   dtpDataEnvioDe.Date := Now;
   dtpDataEnvioAte.Date := Now;
   qrySituacao.Open;
   qryLotesRps.Open;
   qryVariaveis.Open;
end;
   ...
   if chkDataVencto.Checked then
      LSFiltro := LSFiltro + S_OP +
         Format(S_FILTRO_DTVENCTO,
            [QuotedStr(FormatDateTime('yyyy-mm-dd', dtpDataVenctoDe.Date)),
             QuotedStr(FormatDateTime('yyyy-mm-dd', dtpDataVenctoAte.Date))]);

   if chkDataPagto.Checked then
      LSFiltro := LSFiltro + S_OP +
         Format(S_FILTRO_DTPAGTO,
            [QuotedStr(FormatDateTime('yyyy-mm-dd', dtpDataPagtoDe.Date)),
             QuotedStr(FormatDateTime('yyyy-mm-dd', dtpDataPagtoAte.Date))]);

   if chkDataComp.Checked then
      LSFiltro := LSFiltro + S_OP +
         Format(S_FILTRO_DTVENCTO,
            [QuotedStr(FormatDateTime('yyyy-mm-dd', dtpDataCompDe.Date)),
             QuotedStr(FormatDateTime('yyyy-mm-dd', dtpDataCompAte.Date))]);
   ...
   begin
      ...
      LSFiltro := LSFiltro +
         Format(S_FILTRO_DATAENVIO,
            [QuotedStr(FormatDateTime('yyyy-mm-dd', dtpDataEnvioDe.Date)),
             QuotedStr(FormatDateTime('yyyy-mm-dd', dtpDataEnvioAte.Date))])
   end;
   if LSFiltro <> '' then
   begin
