object fMatricularPlano: TfMatricularPlano
  ...
  object pnlOpcoes: TPanel
    ...
    object lblDescontoProg: TLabel
      ...
      Width = 246
      Height = 13
      Caption = 'Este aluno possui um desconto programado'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
      Font.Name = 'Tahoma'
    ...
    object sbVerDescProg: TSpeedButton
      Left = 755
      Top = 16
      Width = 23
      Height = 21
    ...
    object cbUtilizarDescProgramado: TCheckBox
      ...
      Width = 258
      Height = 13
      Caption = 'Utilizar desconto programado para este estudante'
      Checked = True
      State = cbChecked
      TabOrder = 2
      Visible = False
  ...
  object qryPlanoPgto: TUMZReadOnlyQuery
    ...
    SQL.Strings = (
      ...
      '('
        ...
        'DATE_FORMAT(p.dt_vigencia_inicio, '#39'%Y%m%d'#39') <= DATE_FORMAT(NOW()' +
        ', '#39'%Y%m%d'#39')'
      ')'
      'AND ('
      
        '(DATE_FORMAT(p.dt_vigencia_fim, '#39'%Y%m%d'#39') >= DATE_FORMAT(NOW(), ' +
        #39'%Y%m%d'#39')'
      ')'
      ')'
      ')'
  ...
  object cdsParcelas: TClientDataSet
    ...
    Top = 320
    Data = {
      220200009619E0BD01000000180000001400000000000300000022020E43445F
