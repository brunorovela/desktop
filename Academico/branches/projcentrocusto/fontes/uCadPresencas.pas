...
begin
   ...
   mcData.MaxDate := DataAtual;
   mcData.Date := DataAtual;
...
begin
   ...
   qyEtapa.ParamByName('dt_selecionada').AsDate := mcData.Date;
...
begin
   ...
   GerarAulasConformeGradeHorarios(mcData.Date);
...
begin
   ...
   qyHorarios.ParamByName( 'DIA_SEMANA' ).AsInteger := DayOfWeek( mcData.Date );
   qyHorarios.ParamByName( 'DT_SELECIONADA' ).AsDate := mcData.Date;
   ...
   qyListaAulasAluno.ParamByName( 'DT_SELECIONADA' ).AsDate := mcData.Date;
