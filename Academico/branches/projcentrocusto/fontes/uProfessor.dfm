inherited frm_Professores: Tfrm_Professores
  ...
  object tblProfessor: TUMZQuery [29]
    ...
    BeforePost = tblProfessorBeforePost
  ...
  object qyDocumentos: TUMZQuery
    ...
    SQL.Strings = (
      ...
      '  documentos d'
        ...
        '  LEFT JOIN documentos_necessarios dd ON (d.codigo = dd.cod_docu' +
        'mento)'
    ...
    object qyDocumentosCurso: TStringField
      FieldName = 'Curso'
    ...
    object qyDocumentossn_obrigatorio: TStringField
    ...
    object qyDocumentosnr_grupo: TIntegerField
      FieldName = 'nr_grupo'
    end
