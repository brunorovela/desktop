...
Function VerificaPreRequisitosEspeciais(CodAluno: Integer; Curso: String; Disciplina: Integer; Grade: Integer; Anosemestre: Integer): TStringList;
...
begin
   ...
   qyConsulta.SQL.Text := ''+
   'SELECT                            '+
   '	th.cd_horario, th.dia_semana, th_n.cd_horario, th_n.dia_semana, th.disciplina, th_n.disciplina as disciplina_n, d.descricao, '+
