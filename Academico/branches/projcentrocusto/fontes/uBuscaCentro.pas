...
type
  ...
  public
    ...
    function ShowModal(telaCriterios: Boolean = False; tipoCentroBusca: PTipoCentro = tcTodos): TResultadoBuscaCentro; reintroduce;
...
begin
   ...
   if cbAtivoSimples.ItemIndex = 1 then
   begin
      qryCentroSimples.Filter :=
         qryCentroSimples.Filter +
         ' AND sn_ativo = 1';
...
function TfrmBuscaCentro.ShowModal(telaCriterios: Boolean = False; tipoCentroBusca: PTipoCentro = tcTodos): TResultadoBuscaCentro;
begin
