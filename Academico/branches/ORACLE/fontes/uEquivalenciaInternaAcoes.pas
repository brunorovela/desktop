...
type
  ...
  TfEquivInternaAcoes = class(TForm)
    ...
    qryVerificaExistenciaEquivalencia: TUMZQuery;
  ...
  private
      ...
      function verificaExistenciaDuplicidade(iCodigoGrupo1: Integer; iCodigoGrupo2: Integer): boolean;
...
begin
   ...
   cbOposto.Checked := true;
   if(iCodigoGrupo1 > 0) AND (iCodigoGrupo2 > 0) then
   begin
      cbOposto.Checked := verificaExistenciaDuplicidade(iCodigoGrupo1,iCodigoGrupo2);
   end;
...
function TfEquivInternaAcoes.verificaExistenciaDuplicidade(iCodigoGrupo1: Integer; iCodigoGrupo2: Integer): boolean;
begin
   qryVerificaExistenciaEquivalencia.Close;
   qryVerificaExistenciaEquivalencia.ParamByName('grupo1').AsInteger :=  iCodigoGrupo1;
   qryVerificaExistenciaEquivalencia.ParamByName('grupo2').AsInteger :=  iCodigoGrupo2;
   qryVerificaExistenciaEquivalencia.Open;

   result := (qryVerificaExistenciaEquivalencia.FieldByName('cont').AsString > '1');
end;
