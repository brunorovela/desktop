object frm_Retorno_Banco: Tfrm_Retorno_Banco
  ...
  object tblItens: TUMZQuery
    ...
    SQL.Strings = (
      'SELECT '
      #9'ri.cd_retorno codigoretorno,'
      #9'ri.nr_sequencia sequencia,'
      #9'c.ds_ocorrencia ocorrencia,'
      #9'ri.dt_vencimento vencimento,'
      #9'ri.vl_titulo valortitulo,'
      #9'ri.nr_nossonumero nossonumero,'
      #9'ri.vl_pago valorpago,'
      #9'ri.vl_acrescimo valoracrescimo,'
      #9'ri.cd_pessoa codigoaluno,'
      #9'm.parcela parcela,'
      #9'ri.nr_sequencia sequencianoarquivo,'
      #9'ri.dt_pagamento datapagamento,'
      #9'ri.cd_motivo cd_motivo,'
      #9'rit.cd_mensalidade cd_mensalidade,'
      #9'ri.cd_ocorrencia cd_ocorrencia,'
      #9'ri.vl_tarifa vl_tarifa,'
      '  ri.cd_situacao = 10 sn_baixado,'
      #9'ri.dt_credito dt_credito,'
      '  c.sn_baixar,'
      '  m.turma,'
      '  m.ds_historico,'
      '  m.valorbruto,'
      ...
      '  p.ds_cpf,'
      '  b.ds_motivo,'
      '  resp.nm_pessoa responsavel'
      'FROM'
      #9'retorno_itens ri '
      ''
      #9#9'JOIN retorno r on'
      #9#9#9'(ri.cd_retorno = r.codigo)'
      ''
      #9#9#9'LEFT JOIN retorno_itens_titulos rit ON'
      #9#9#9#9'(ri.cd_retorno = rit.cd_retorno) AND'
      #9#9#9#9'(ri.nr_sequencia = rit.nr_sequencia)'
      ''
      #9#9#9'LEFT JOIN mensalidades m ON'
      #9#9#9#9'(rit.cd_mensalidade = m.cd_mensalidade)'
      ''
      #9#9'LEFT JOIN pessoas p ON'
      #9#9#9'(ri.cd_pessoa = p.cd_pessoa)'
      ''
      #9#9#9#9'LEFT JOIN pessoas resp ON'
      #9#9#9#9#9'(m.cd_resp = resp.cd_pessoa)'
      ''
      #9#9#9#9'LEFT JOIN banco_codigo_retorno c ON'
      #9#9#9#9#9'(c.cd_retorno = ri.cd_ocorrencia) AND'
      #9#9#9#9#9'(c.cd_banco = r.cd_banco) AND'
      #9#9#9#9#9'(c.cd_origem = 1)'
      ''
      #9#9#9#9#9'LEFT JOIN banco_retorno_motivos b ON'
      #9#9#9#9#9#9'(b.cd_banco = r.cd_banco) AND'
      #9#9#9#9#9#9'(b.cd_motivo = ri.cd_motivo) AND'
      #9#9#9#9#9#9'(c.cd_grupo_motivos = b.cd_grupo_motivos)'
      'WHERE'
      #9'ri.cd_retorno = :codigoretorno'
      'ORDER BY'
      '  ri.nr_sequencia')
    ...
    object tblItenscd_mensalidade: TIntegerField
      Tag = 1
    ...
    object tblItenssn_baixado: TLargeintField
  ...
  object qItensGrupo: TUMZQuery
    ...
    SQL.Strings = (
      'SELECT'
      #9'B.DS_OCORRENCIA OCORRENCIA'
      'FROM'
      #9'RETORNO_ITENS I'
      #9#9'JOIN RETORNO R ON'
      #9#9#9'(I.CD_RETORNO = R.CODIGO)'
      #9#9'JOIN BANCO_CODIGO_RETORNO B ON'
      #9#9'(I.CD_OCORRENCIA = B.CD_RETORNO) AND'
      #9#9'(R.CD_BANCO = B.CD_BANCO)'
      'WHERE'
      #9'R.CODIGO = :CODIGORETORNO AND'
      #9'B.CD_ORIGEM = 1'
      'GROUP BY'
      #9'B.DS_OCORRENCIA')
    Params = <
