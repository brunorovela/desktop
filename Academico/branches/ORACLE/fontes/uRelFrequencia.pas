...
uses
  ...
  ExtCtrls, QuickRpt, Qrctrls, uDM, uDMDiario;

type
  TFormRelFrequencia = class(TForm)
    QuickRep1: TQuickRep;
...
var
  FormRelFrequencia: TFormRelFrequencia;
  Repete : Boolean;
...
procedure TFormRelFrequencia.ColumnHeaderBand1BeforePrint(
...
begin
   ...
   Begin
     if not DMDiario.qAulas.Eof Then
       Begin
          if mes <> Copy(DMDiario.qAulasDATA.AsString,4,2) Then
          Begin
              ...
              mes := Copy(DMDiario.qAulasDATA.AsString,4,2);
          End
          Else
          Begin
...
procedure TFormRelFrequencia.SummaryBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
   if DMDiario.qAulas.RecordCount > 23 Then
     PrintBand := False
   Else
...
procedure TFormRelFrequencia.QRLabel2Print(sender: TObject;
  var Value: String);
begin
