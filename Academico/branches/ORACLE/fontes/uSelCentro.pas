...
type
  Tfrm_SelCentro = class(TForm)
    ...
    qyCentrosCD_COLIGADA_MATRIZ: TIntegerField;
    qyCentrosDS_CENTRO: TStringField;
    qyCentrosDS_OBSERVACAO: TMemoField;
    qyCentrosCD_CLASSIFICACAO: TStringField;
    qyCentrosTP_CENTRO: TSmallintField;
    qyCentrosCD_GRUPO: TLargeintField;
    qyCentrosSN_ATIVO: TSmallintField;
    qyCentrosCD_CENTRO_PAI: TIntegerField;
    qyCentrosDS_SQL: TMemoField;
    qyCentrosCD_CONTABILIDADE: TStringField;
    qyCentrosNR_TIPO_REGRA: TIntegerField;
...
procedure Tfrm_SelCentro.btnConfirmarClick(Sender: TObject);
begin
  flgSearch := True;
  Close;
end;
