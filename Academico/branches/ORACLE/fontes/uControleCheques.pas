...
begin
   ...
   if sFSituacao = '' then
      ...
      frmProcuraCheque.cbListaSituacao.ItemIndex := frmProcuraCheque.slSituacoes.IndexOfName(sFSituacao)+1;
...
begin
   ...
   fTransferenciaCheques.iContaPadrao :=  qryChequesCD_CAIXA.AsInteger;
