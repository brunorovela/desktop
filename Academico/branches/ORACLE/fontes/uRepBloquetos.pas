...
const
  SQL_STATUS_NN =
    ...
    ' FROM '+
    '     mensalidades m '+
    '     LEFT JOIN rem_status rs ON (rs.nr_nossonumero = m.nossonumero) '+
...
const
  ...
  SQL_BOLETOS_IMPRIMIR_TABELAS_AGRUPADO =
    ...
    '         COALESCE(tt1.ds_grupo_boleto, "A") = COALESCE(tt.ds_grupo_boleto, "A") '+
    '     ) ';
  ...
  SQL_BOLETOS_IMPRIMIR_TABELAS_DESAGRUPADO =
   ...
   SQL_BOLETOS_IMPRIMIR_TABELAS =
    ...
    '     ) AND ' +
    // As linhas abaixo não selecionarão mensalidades que possuem DDA na fila de envio
    ' NOT EXISTS ( ' +
    '     SELECT ' +
    '         re.cd_envio ' +
    '     FROM ' +
