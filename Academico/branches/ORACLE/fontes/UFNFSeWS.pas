...
begin
   ...
   FNFSeCad.umdtEnvioInicio.Date := Now;
   FNFSeCad.umdtEnvioFim.Date := Now;
...
begin
   FNFSeFiltro.umdtVencIni.Date := Now;
   FNFSeFiltro.umdtVencFim.Date := Now;
   FNFSeFiltro.umdtPagIni.Date := Now;
   FNFSeFiltro.umdtPagFim.Date := Now;
   FNFSeFiltro.umdtCompIni.Date := Now;
   FNFSeFiltro.umdtCompFim.Date := Now;
