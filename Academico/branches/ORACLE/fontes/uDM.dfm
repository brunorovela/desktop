object DM: TDM
  ...
  object qryInsert: TUMZQuery
    ...
    SQLList.Strings = (
        ...
        '_PERCENTUAL_DIVISAO, cd_desc_condicional, ds_obs_desc, cd_resp_n' +
        'fse'#13#10')'#13#10'VALUES'#13#10'('#13#10':CodigoAluno,  :cd_resp, :Parcela, TO_DATE(:D' +
        'ataVencimento, '#39'YYYY-MM-DD'#39'), TO_DATE(:dt_competencia, '#39'YYYY-MM-' +
        'DD'#39'), :Turma, TO_DATE(:DataEmissao, '#39'YYYY-MM-DD'#39'),'#13#10':NossoNumero' +
        ', :ValorBruto, :ValorDesconto, :DescontoExtra, :ValorExtra,'#13#10':Va' +
        'lorTotal, :ValorJuros, :valorjuros_fixo, :ValorPago, :DataPagame' +
        'nto, :Situacao,'#13#10':Usuario, :Bloqueto, :AnoSemestre, '#13#10'TO_DATE(:D' +
        'ataBaseCorrecao, '#39'YYYY-MM-DD'#39'), :IndiceCorrecao, :Curso, :Depto,' +
        ' :Tipo, :sn_credito_parcela, :cd_mensalidade_origem, :nr_credito' +
        's,'#13#10':ds_historico, :cd_tipo_titulo, :cd_plano_conta, :cd_centro_' +
        'custo, :cd_caixa, :ValorCredito, :CodItemPlano, :cd_cheque_devol' +
        'vido, :cd_coligada, :SN_NFE_GERADA, :NR_NF, :VL_PERCENTUAL_DIVIS' +
        'AO, :cd_desc_condicional, :ds_obs_desc, :cd_resp_nfse'#13#10')'
        ...
        'nal, ds_obs_desc, sn_liberar_descontos, cd_resp_nfse'#13#10')'#13#10'VALUES'#13 +
        #10'('#13#10':CodigoAluno,  :cd_resp, :Parcela, :DataVencimento, :dt_comp' +
        'etencia, :Turma, :DataEmissao,'#13#10':NossoNumero, :ValorBruto, :Valo' +
        'rDesconto, :DescontoExtra, :ValorExtra,'#13#10':ValorTotal, :ValorJuro' +
        's, :valorjuros_fixo, :ValorPago, :DataPagamento, :Situacao,'#13#10':Us' +
        'uario, :Bloqueto, :AnoSemestre, '#13#10':DataBaseCorrecao, :IndiceCorr' +
        'ecao, :Curso, :Depto, :Tipo, :sn_credito_parcela, :cd_mensalidad' +
        'e_origem, :nr_creditos,'#13#10':ds_historico, :cd_tipo_titulo, :cd_pla' +
        'no_conta, :cd_centro_custo, :cd_caixa, :ValorCredito, :CodItemPl' +
        'ano, :cd_cheque_devolvido, :cd_coligada, :SN_NFE_GERADA, :NR_NF,' +
        #13#10':ds_autentica_impressao, :VL_PERCENTUAL_DIVISAO, :cd_desc_cond' +
        'icional, :ds_obs_desc, :sn_liberar_descontos, :cd_resp_nfse'#13#10')')
    Left = 192
    Top = 310
    ParamData = <
      item
