...
type
   TfNFSeFiltro = class(TFrame)
    ...
    umdtVencIni: TUMDateTimePicker;
    umdtVencFim: TUMDateTimePicker;
    umdtPagFim: TUMDateTimePicker;
    umdtPagIni: TUMDateTimePicker;
    umdtCompIni: TUMDateTimePicker;
    umdtCompFim: TUMDateTimePicker;
...
begin
   umdtCompIni.Enabled := chkComp.Enabled;
   umdtCompFim.Enabled := chkComp.Enabled;
...
begin
   umdtPagIni.Enabled := chkPgto.Enabled;
   umdtPagFim.Enabled := chkPgto.Enabled;
...
begin
   umdtVencIni.Enabled := chkVencto.Checked;
   umdtVencFim.Enabled := chkVencto.Checked;
   btnSalvar.Enabled := False;
end;
...
begin
   ...
   begin
      ...
      AddParam('DT_VENCTO_INI', umdtVencIni.Date);
      AddParam('DT_VENCTO_FIM', umdtVencFim.Date);
   end;

   if chkPgto.Checked then
   begin
      Filtro := Filtro + SOp + SFilPgto;
      AddParam('DT_PGTO_INI', umdtPagIni.Date);
      AddParam('DT_PGTO_FIM', umdtPagFim.Date);
   end;

   if chkComp.Checked then
   begin
      Filtro := Filtro + SOp + SFilComp;
      AddParam('DT_COMP_INI', umdtCompIni.Date);
      AddParam('DT_COMP_FIM', umdtCompFim.Date);
   end;
