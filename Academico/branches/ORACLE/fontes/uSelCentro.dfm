object frm_SelCentro: Tfrm_SelCentro
  ...
  object qyCentros: TUMZQuery
    ...
    object qyCentrosCD_COLIGADA_MATRIZ: TIntegerField
    ...
    object qyCentrosTP_CENTRO: TSmallintField
      FieldName = 'TP_CENTRO'
    end
    ...
    object qyCentrosCD_CENTRO_PAI: TIntegerField
      FieldName = 'CD_CENTRO_PAI'
    end
    object qyCentrosDS_SQL: TMemoField
      FieldName = 'DS_SQL'
      BlobType = ftMemo
    end
    object qyCentrosCD_CONTABILIDADE: TStringField
      FieldName = 'CD_CONTABILIDADE'
      Size = 255
    end
    object qyCentrosNR_TIPO_REGRA: TIntegerField
