...
var
   I: Integer;
   coligada_filtro : String;
begin
   inherited Create(nil);
   Self.FICodColigada := AICodColigada;
   coligada_filtro    := IntToStr(DM.UsuarioLogado.GetColigadaLogada.Codigo);
  ...
  '  FROM                                                                               '+
	...
	'     INNER JOIN fin_cadastro_contas_tipos t ON (t.cd_tipo = c.tp_conta)              '+
  '     INNER JOIN coligadas as co ON (co.cd_coligada = c.cd_coligada )                 '+
  '  WHERE                                                                              '+
	'     co.cd_coligada_matriz = ' + coligada_filtro + '                                 '+
  '  ORDER BY                                                                           '+
	'     c.sn_ativa = "S",                                                               '+
	'     c.ds_caixa;                                                                     ';
