...
begin
   ...
   Self.Grid.ColWidths[1] := 83;
   
   Self.Grid.Cells[0,0] := 'Descrição';
   Self.Grid.Cells[1,0] := 'Período';
...
begin
   ...
   begin
      ...
      Grid.Cells[1,I] := Horario.HoraInicio;
...
begin
   ...
   begin
      Result := ' UPDATE turmas_horarios_config  ' +
                ...
                '    nr_anosemestre = :nr_anosemestre AND cd_turma = :cd_turma AND ' +
                '    cd_turma_base = :cd_turma_base AND cd_disciplina = :cd_disciplina AND ' +
                '    cd_horario = :cd_horario AND nr_dia_semana = :nr_dia_semana AND sn_ativo = 1 ';
   end;
end;
