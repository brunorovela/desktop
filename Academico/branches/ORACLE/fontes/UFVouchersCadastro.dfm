object frmVouchersCadastro: TfrmVouchersCadastro
  ...
  object pnlDados: TPanel
    ...
    object dtpVencto: TDateTimePicker
      ...
      Width = 133
      Height = 21
      Date = 42796.550770578700000000
      Time = 42796.550770578700000000
      ShowCheckbox = True
      Checked = False
      TabOrder = 3
    end
    ...
    object cbVoucherUnico: TCheckBox
      Left = 362
      Top = 218
      Width = 97
      Height = 17
      Caption = 'Voucher '#250'nico'
      TabOrder = 9
      OnClick = cbVoucherUnicoClick
    end
  ...
  object qryTotalizadores: TUMZReadOnlyQuery
    ...
    SQL.Strings = (
      'SELECT'
      '  COUNT(*) `NR_TOTAL`,'
      '  COUNT(`CD_PESSOA`) `NR_UTILIZADOS`,'
      '  MAX(`NR_SEQUENCIAL`) `NR_ULTIMO`'
      'FROM'
      '  `UNIM_VOUCHER`'
      'WHERE'
      '  `CD_LOTE` = :CD_LOTE')
  ...
  object qryVouchers: TUMZQuery
    Connection = DM.db
    AfterApplyUpdates = cbVoucherUnicoClick
    SQL.Strings = (
      'SELECT'
      '  `CD_VOUCHER`,'
      '  `CD_LOTE`,'
