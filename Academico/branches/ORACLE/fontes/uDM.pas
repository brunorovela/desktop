...
type
  ...
  public
    ...
    procedure DuplicarProvaDisciplinaFrente(iAnosemestre: Integer; sCurso: string; sTurma: string; iDisciplina: Integer; iDisciplinaFrente: Integer; iBimestre: Integer;iNrProvaFilha : Integer; bDuplicaTodas: Boolean = false);
...
procedure TDM.DuplicarProvaDisciplinaFrente(iAnosemestre: Integer; sCurso,
  sTurma: string; iDisciplina, iDisciplinaFrente, iBimestre: integer; iNrProvaFilha : Integer; bDuplicaTodas : Boolean);
var
