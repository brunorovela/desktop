...
begin
   ...
   end; // Fim da repetiração da impressão de recibos
...
const
   TextQ = 'O título selecionado possui um pedido de inclusão no DDA. Para efetuar a impressão do boleto, é necessário cancelar a sua inclusão no DDA. Deseja efetuar o cancelamento do DDA e efetuar a impressão do boleto?';
   CaptionQ = 'Atenção';
   TextI = 'O pedido de cancelamento do DDA foi registrado. O boleto será impresso.';
   CaptionI = 'Informação';
var
   Remessa: TRemessa;
   UserChoice: Integer;
...
begin
   ...
   try
      Stmt.SetInt(1, FUMRecMensalidade.Cd_Mensalidade );
