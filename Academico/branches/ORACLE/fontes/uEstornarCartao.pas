...
begin
   ...
   begin
      ...
      iCodSaida := mvSaida.RegistrarMovimentacaoTe(qyContasEstornar.FieldByName('cd_caixa_atual').AsInteger);
      ...
      registraHist.codMovEntrada := mvEntrada.RegistrarMovimentacaoTe(qyContasEstornar.FieldByName('cd_caixa').AsInteger);
      { REALIZA TRANSFERÊNCIA }
      ...
      cdMovimentoTaxa := mvSaida.RegistrarMovimentacaoTe(qyContasEstornar.FieldByName('cd_caixa').AsInteger);
