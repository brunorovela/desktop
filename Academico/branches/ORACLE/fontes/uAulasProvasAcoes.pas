...
uses
  ...
  UMDateTimePicker, ZDbcIntfs, UZDbcFuncs;
...
begin
   ...
   if sTime = '  :  ' then
   begin
      umdtAvaliacao.Text := DateTimeToStr(dataUltimaAula)+' 00:00';
   end else begin
      umdtAvaliacao.Text := DateTimeToStr(dataUltimaAula)+' '+sTime;
   end;
end;
...
begin
   ...
   begin
      ...
      begin
         chkAI.Checked := False;
         umdtAvaliacao.Text := FormatDateTime('dd/mm/yyyy 00:00', now());
      end;
      ...
      qyAvaliacaoCronograma.ParamByName('nr_anosemestre').AsInteger := qCronograma.FieldByName( 'anosemestre' ).AsInteger;
      ...
      end else if cbAvaliacao.Items.Count > 0 then
      begin
