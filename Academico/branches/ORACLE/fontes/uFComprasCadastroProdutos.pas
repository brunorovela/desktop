...
begin
   ...
   if(qyCategoriassn_cantina.AsInteger = 1) then
   begin
...
begin
   ...
   dbNrParcelas.Enabled := (qyCategoriassn_cantina.AsInteger = 0);
   edLimite.Enabled := (qyCategoriassn_cantina.AsInteger = 0);
   DBCheckBox1.Enabled := (qyCategoriassn_cantina.AsInteger = 0);
   ckbGerarTitulo.Enabled :=  ckbGerarTitulo.Enabled and (qyCategoriassn_cantina.AsInteger = 0);
   dbchBaixarTitulo.Enabled := ckbGerarTitulo.Enabled;
   ckbAcumularValores.Enabled := ckbAcumularValores.Enabled and (qyCategoriassn_cantina.AsInteger = 0);
   ckbImprimirCupom.Enabled := (qyCategoriassn_cantina.AsInteger = 0);
