...
begin
  ...
  if Trim(strNumero) <> '' then begin
     ...
     if (sColCPF <> '') AND (sColVencimento <> '') then begin
         ...
         if snAlunoEmCobranca then begin
            Dm.tblMensalidades.SQL.Add('  INNER JOIN fin_cobranca ON (fin_cobranca.cd_pessoa = Mensalidades.codigoaluno AND fin_cobranca.sn_spc = 1) ');
         end;
    ...
    if qryItenscd_situacao.AsInteger <> 10 then begin
        ...
        End ELSE Begin
           ...
           if Dm.isTrue(qryItenssn_baixar.AsString) then Begin
              ...
              if BuscaNossoNumero(strNossoNumero, '(situacao = 2 OR situacao = 8 OR situacao = 10)', true) then begin
