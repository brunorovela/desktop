...
type
  Tfrm_CadAcoesMovto = class(TForm)
    ...
    qyAcoesMovtosn_desconto_valor_fixo: TSmallintField;
...
begin
  ...
  if (qyAcoesMovtocd_tipo_acao.AsString = '') then
  Begin
    Mensagem('Não é possível salvar uma nova ação de movimento, sem um tipo de ação selecionada.', Application.Title, MB_OK + MB_ICONWARNING );
