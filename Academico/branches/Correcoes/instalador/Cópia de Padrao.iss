...
SourceDir=C:\Programacao\Desenvolvimento\unimestre\Academico\trunk
OutputBaseFilename=AtualizaTeste-2.25.1.1
VersionInfoVersion=2.25.1.1
VersionInfoCompany=Uninformare Informática
VersionInfoDescription=ACADÊMICO
VersionInfoTextVersion=ACADÊMICO 2.25.1.1
Compression=lzma/ultra
AppName=ACADÊMICO
AppVerName=2.25.1.1
InfoBeforeFile=C:\Programacao\Desenvolvimento\unimestre\Academico\branches\Correcoes\instalador\1-academico.txt
DirExistsWarning=no
...
Source: C:\Programacao\Desenvolvimento\unimestre\atualiza\branches\tgas\stable; DestDir: {tmp}; Flags: deleteafterinstall overwritereadonly uninsremovereadonly
...
Filename: {reg:HKLM\Software\Uninformare\UNIMESTRE,AtualizaPath|{app}\programas\atualiza.exe}; Parameters: "--invisivel ""{tmp}\1-academico.unm"""; WorkingDir: {tmp}; Flags: runhidden
