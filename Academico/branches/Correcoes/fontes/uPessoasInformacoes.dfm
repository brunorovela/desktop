object fPessoasInformacoes: TfPessoasInformacoes
  ...
  object qryPessoasInfoFiltrar: TUMZQuery
    ...
    object qryPessoasInfoFiltrards_informacao: TMemoField
      Tag = 1
      DisplayLabel = 'Descri'#231#227'o'
      FieldName = 'ds_informacao'
      OnGetText = qryPessoasInfoFiltrards_informacaoGetText
      BlobType = ftMemo
      Size = 1000
    end
    ...
    object qryPessoasInfoFiltrarcd_consultor: TIntegerField
      FieldName = 'cd_consultor'
    end
    object qryPessoasInfoFiltrards_status_1: TStringField
      FieldName = 'ds_status_1'
      Size = 255
    end
    object qryPessoasInfoFiltrards_area_assunto: TStringField
      FieldName = 'ds_area_assunto'
      Size = 255
    end
    object qryPessoasInfoFiltrards_curso: TStringField
      FieldName = 'ds_curso'
      Size = 150
    end
    object qryPessoasInfoFiltrards_endereco: TStringField
      FieldName = 'ds_endereco'
      Size = 255
    end
    object qryPessoasInfoFiltrardt_retorno: TDateTimeField
      Tag = 1
    ...
    object qryPessoasInfoFiltrarcd_conhecimento: TIntegerField
      FieldName = 'cd_conhecimento'
    end
    object qryPessoasInfoFiltrards_complemento: TStringField
      Tag = 1
      DisplayLabel = 'Complemento de Inscri'#231#227'o'
      FieldName = 'ds_complemento'
      Size = 50
    end
    object qryPessoasInfoFiltrarnm_dependente: TStringField
      Tag = 1
      DisplayLabel = 'Nome do Dependente'
      FieldName = 'nm_dependente'
      Size = 150
    end
    object qryPessoasInfoFiltrardt_nascimento: TDateTimeField
      Tag = 1
      DisplayLabel = 'Data de Nascimento do Dependente'
      FieldName = 'dt_nascimento'
    end
    object qryPessoasInfoFiltrarnr_anosemestre: TSmallintField
      Tag = 1
      DisplayLabel = 'Ano/Semestre'
      FieldName = 'nr_anosemestre'
    end
    object qryPessoasInfoFiltrards_chave: TStringField
      Tag = 1
      DisplayLabel = 'Chave Sequencial'
      FieldName = 'ds_chave'
    end
    object qryPessoasInfoFiltrarcd_dependente: TIntegerField
      Tag = 1
      DisplayLabel = 'C'#243'd. Dependente'
      FieldName = 'cd_dependente'
    end
    object qryPessoasInfoFiltrards_origem: TStringField
      FieldKind = fkLookup
      FieldName = 'ds_origem'
      LookupDataSet = qryInfoPor
      LookupKeyFields = 'codigo'
      LookupResultField = 'ds_valor'
      KeyFields = 'cd_origem'
      Lookup = True
    end
    object qryPessoasInfoFiltrards_cidade_lk: TStringField
      FieldKind = fkLookup
    ...
    object qryPessoasInfoFiltrards_estado: TStringField
      FieldKind = fkLookup
      FieldName = 'ds_estado'
    ...
    object qryPessoasInfoFiltrards_obs4: TStringField
      FieldName = 'ds_obs4'
      Size = 255
    end
    object qryPessoasInfoFiltrards_cor_situacao: TStringField
      FieldKind = fkLookup
      FieldName = 'ds_cor_situacao'
      LookupDataSet = qrySituacoes
      LookupKeyFields = 'DS_VALOR'
      LookupResultField = 'DS_SIGLA'
      KeyFields = 'ds_status'
      Size = 7
      Lookup = True
    end
    object qryPessoasInfoFiltrards_conhecimento: TStringField
      Tag = 1
      DisplayLabel = 'Ficou sabendo'
      FieldName = 'ds_conhecimento'
      Size = 60
    end
  end
  ...
  object qryInfoPor: TUMZQuery
    ...
    Left = 8
    Top = 408
    object qryInfoPorcodigo: TLargeintField
      FieldName = 'codigo'
      Required = True
    end
    object qryInfoPorcd_situacao: TIntegerField
      FieldName = 'cd_situacao'
    end
    object qryInfoPords_valor: TStringField
      FieldName = 'ds_valor'
      Size = 255
    end
  end
  ...
  object updPessoaInfo: TZUpdateSQL
    DeleteSQL.Strings = (
      'DELETE FROM'
      #9'CONTATOS_CADASTRO_MEMO'
      'WHERE'
      #9'CD_INFORMACAO = :CD_INFORMACAO;'
      ''
      'DELETE FROM'
      #9'CONTATOS_CADASTRO '
      'WHERE '
    ...
    ModifySQL.Strings = (
      ...
      #9'PESSOAS_INFO'
      'SET'
      #9'DS_INFORMACAO = :DS_INFORMACAO,'
      #9'NM_PESSOA = :NM_PESSOA,'
      #9'DS_CONTATOS = :DS_CONTATOS,'
      #9'DT_INFORMACAO = :DT_INFORMACAO,'
      #9'CD_ORIGEM = :CD_ORIGEM,'
      #9'CD_TURMA = :CD_TURMA,'
      #9'DS_OBS1 = :DS_OBS1,'
      #9'DS_OBS2 = :DS_OBS2,'
      #9'DS_OBS3 = :DS_OBS3,'
      #9'DS_TELEFONE2 = :DS_TELEFONE2,'
      #9'DS_EMAIL = :DS_EMAIL,'
      #9'CD_COLIGADA = :CD_COLIGADA,'
      #9'NM_USUARIO = :NM_USUARIO,'
      #9'CD_PESSOA = :CD_PESSOA,'
      #9'DS_CIDADE = :DS_CIDADE,'
      #9'DS_UF = :DS_UF,'
      #9'CD_CONHECIMENTO = :CD_CONHECIMENTO,'
      #9'DS_ENDERECO = :DS_ENDERECO,'
      #9'DS_TELEFONE3 = :DS_TELEFONE3,'
      #9'DS_TELEFONE4 = :DS_TELEFONE4,'
      #9'DS_CURSO = :DS_CURSO,'
      #9'DT_RETORNO = :DT_RETORNO,'
      #9'DS_AREA_ASSUNTO = :DS_AREA_ASSUNTO,'
      #9'DS_OBS4 = :DS_OBS4,'
      #9'CD_CONSULTOR = :CD_CONSULTOR,'
      #9'DS_STATUS = :DS_STATUS,'
      #9'DS_CEP = :DS_CEP,'
      #9'DS_BAIRRO = :DS_BAIRRO,'
      #9'DS_ENDERECO_NRO = :DS_ENDERECO_NRO,'
      #9'NM_DEPENDENTE = :NM_DEPENDENTE,'
      #9'DS_COMPLEMENTO = :DS_COMPLEMENTO,'
      #9'DT_NASCIMENTO = :DT_NASCIMENTO,'
      #9'NR_ANOSEMESTRE = :NR_ANOSEMESTRE,'
      #9'DS_CHAVE = :DS_CHAVE,'
      #9'CD_DEPENDENTE = :CD_DEPENDENTE'
      'WHERE'
      #9'CD_INFORMACAO = :CD_INFORMACAO')
