...
uses
  ...
  ExtCtrls, ZAbstractRODataset, ZAbstractDataset, UZDataset, UMDateTimePicker;
...
procedure TfExportacaoDadosAlteraProcesso.qyProcessoAfterEdit(
  DataSet: TDataSet);
begin
   umdtProcesso.Date := qyProcessodt_processo.AsDateTime;
end;

procedure TfExportacaoDadosAlteraProcesso.qyProcessoBeforePost(
  DataSet: TDataSet);
begin
   qyProcessodt_processo.AsDateTime := umdtProcesso.Date;
end;
