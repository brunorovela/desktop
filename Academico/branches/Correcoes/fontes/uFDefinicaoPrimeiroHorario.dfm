object frmDefinicaoPrimeiroHorario: TfrmDefinicaoPrimeiroHorario
  Left = 0
  Top = 0
  BorderIcons = []
  Caption = 'Selecione a data inicial do hor'#225'rio da turma'
  ClientHeight = 126
  ClientWidth = 494
  Color = clBtnFace
  ...
  object Label3: TLabel
    ...
    Width = 187
    Height = 18
    Caption = 'A data inicial do hor'#225'rio sera:'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -15
    Font.Name = 'Tahoma'
  ...
  object Panel3: TPanel
    ...
    Caption = 'DEFINIR DATA DE IN'#205'CIO PARA O HOR'#193'RIO DA TURMA'
    Color = clBlue
