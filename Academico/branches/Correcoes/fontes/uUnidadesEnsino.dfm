object frmUnidadesEnsino: TfrmUnidadesEnsino
    ...
    object tsDeptos: TTabSheet
      ...
      object pnDepartamentos: TPanel
        ...
        object ScrollBox1: TScrollBox
          ...
          object DBEEnderecoDepto: TDBEdit
            Left = 10
            Top = 598
            Width = 373
            Height = 22
          ...
          object DBEEmailDepto: TDBEdit
            Left = 10
            Top = 640
            Width = 373
            Height = 22
            DataField = 'ds_email_depto'
            DataSource = dtcDeptos
            TabOrder = 18
          end
        end
  ...
  object tblDeptos: TUMZQuery
    ...
    object tblDeptosds_endereco: TStringField
      FieldName = 'ds_endereco'
      Size = 255
    end
    object tblDeptosds_bairro: TStringField
      FieldName = 'ds_bairro'
      Size = 100
    end
    object tblDeptosds_cidade: TStringField
      FieldName = 'ds_cidade'
      Size = 255
    end
    object tblDeptosds_estado: TStringField
      FieldName = 'ds_estado'
      Size = 2
    end
    object tblDeptosds_cep: TStringField
      FieldName = 'ds_cep'
      EditMask = '00000\-000;0;_'
      Size = 8
    end
    object tblDeptosds_email_depto: TStringField
      FieldName = 'ds_email_depto'
      Size = 100
    end
  end
