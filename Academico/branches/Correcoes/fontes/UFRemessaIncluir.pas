...
begin
   ...
   try
      ...
      if qryAcoesDS_CHAVE.AsString = 'incluir_dda' then
      begin
         Filters.Add(SQLFiltroIncluirDDA);
      end;
...
const
   ...
   SuccessMsg = 'O processo de lançamento da remessa de Débito Automático foi finalizado com sucesso.';
   ErrorMsgFmt = 'Ocorreu um erro durante o processo de lançamento do Débito Automático na remessa: %s';
   ErrorCaption = 'Erro';
