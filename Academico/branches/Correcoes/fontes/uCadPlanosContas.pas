...
type
  Tfrm_CadPlanoContas = class(TForm)
    ...
    qyPlanosContassn_restringir_permissao: TSmallintField;
    DBCheckBox2: TDBCheckBox;
    procedure qyPlanosContasNewRecord(DataSet: TDataSet);
...
{
Foi retirado este código em 22/07/2019 devido a lentidão demasiada nesta tela.
Avaliar na migração full web.
...
procedure Tfrm_CadPlanoContas.qyPlanosContasNewRecord(DataSet: TDataSet);
begin
   qyPlanosContassn_restringir_permissao.AsInteger := 0;
end;
