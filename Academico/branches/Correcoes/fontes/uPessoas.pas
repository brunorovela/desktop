...
begin
   ...
   // Funcionalidade bloqueada pois foi migrada para o gestão online.
   Mensagem('A alteração de código de pessoa foi bloqueada no sistema desktop. Por favor, utilize o gestão online.', 'Atenção', MB_OK + MB_ICONWARNING);
   Exit;
