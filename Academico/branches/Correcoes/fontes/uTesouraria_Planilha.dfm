object frm_Tesouraria_Planilha: Tfrm_Tesouraria_Planilha
  ...
  object qyCalcCC: TUMZQuery
    ...
    SQLList.Strings = (
        ...
        'A'#13#10'FROM'#13#10'   FIN_APROPRIA_TE FT'#13#10'      LEFT JOIN FIN_CENTRO_CUSTO' +
        'S CC ON'#13#10'         (FT.CD_COLIGADA = CC.CD_COLIGADA) AND'#13#10'       ' +
        '  (FT.CD_CENTRO = CC.CD_CENTRO)'#13#10'      LEFT JOIN FIN_PLANO_CONTA' +
        'S PC ON'#13#10'         (FT.CD_COLIGADA = PC.CD_COLIGADA) AND'#13#10'       ' +
        '  (FT.CD_CONTA = PC.CD_CONTA)'#13#10'WHERE'#13#10'   FT.CD_MOVIMENTO_TE = :C' +
        'D_MOVIMENTO_TE'#13#10'GROUP BY'#13#10'   CC.CD_CENTRO')
    Left = 440
    Top = 224
    ParamData = <
      item
