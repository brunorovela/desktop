...
begin
  ...
  tblFicha.DisableControls;
    ...
    begin
       tblDigProva.Post;
       sChave:= tblDigProvaCodigoAluno.AsString + ';' + tblDigProvaAnoSemestre.AsString + ';'
       + tblDigProvaTurma.AsString;
       sObservacao:= 'Alteração nas seguintes informações da PI: ' +
       'Nota Redação: ' + tblDigProvaNotaRedacao.AsString + ', ' +
       'Nota Prova: ' + tblDigProvaNotaProva.AsString + ', ' +
       'Média PI: ' + tblDigProvaMediaInstitucional.AsString ;
       DM.setLog(1013,'Alteracao',sChave,1,sObservacao);
    end;
