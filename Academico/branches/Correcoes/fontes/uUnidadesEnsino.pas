...
type
  TfrmUnidadesEnsino = class(TForm)
    ...
    tblDeptosds_endereco: TStringField;
    Label21: TLabel;
    DBEEnderecoDepto: TDBEdit;
    tblDeptosds_bairro: TStringField;
    tblDeptosds_cidade: TStringField;
    tblDeptosds_estado: TStringField;
    tblDeptosds_cep: TStringField;
    tblDeptosds_email_depto: TStringField;
    Label22: TLabel;
    DBEEstadoDepto: TDBEdit;
    Label23: TLabel;
    DBECidadeDepto: TDBEdit;
    Label24: TLabel;
    DBEBairroDepto: TDBEdit;
    Label25: TLabel;
    DBECEPDepto: TDBEdit;
    Label26: TLabel;
    DBEEmailDepto: TDBEdit;
