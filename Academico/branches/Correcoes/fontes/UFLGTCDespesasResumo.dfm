object frmLGTCDespesasResumo: TfrmLGTCDespesasResumo
  ...
  object qryDespesas: TUMZQuery
    ...
    object qryDespesasCD_HISTORICO_CP: TIntegerField
      FieldName = 'CD_HISTORICO_CP'
    end
    object qryDespesasNR_DIAS_VENCIMENTO: TIntegerField
  ...
  object qryContaPagar: TUMZQuery
    ...
    object qryContaPagarCD_HISTORICO: TIntegerField
  ...
  object cdsContaPagar: TClientDataSet
    ...
    object cdsContaPagarCD_HISTORICO: TIntegerField
      FieldName = 'CD_HISTORICO'
    end
  end
  ...
  object cdsCompromissos: TClientDataSet
    ...
    object cdsCompromissosCD_HISTORICO: TIntegerField
      FieldName = 'CD_HISTORICO'
    end
  end
  ...
  object cdsDespesas: TClientDataSet
    ...
    object cdsDespesasCD_HISTORICO_CP: TIntegerField
      FieldName = 'CD_HISTORICO_CP'
    end
    object cdsDespesasNR_DIAS_VENCIMENTO: TIntegerField
      FieldName = 'NR_DIAS_VENCIMENTO'
    end
  end
  ...
  object qryCamposAdicionaisFormaPgto: TUMZReadOnlyQuery
    Connection = DM.db
    SQL.Strings = (
      'SELECT'
      '  fp.cd_forma_pgto'
      ...
      '  pessoas_cadastro pc'
        ...
        #9'INNER JOIN fin_formas_pgto fp ON (fp.ds_forma_pgto = pc.ds_cont' +
        'eudo)'
      'WHERE'
      #9'fp.cd_coligada = :CD_COLIGADA AND'
      #9'pc.cd_pessoa = :CD_PESSOA AND'
      #9'pc.cd_campo = :CD_CAMPO')
    Params = <
      item
        DataType = ftUnknown
        Name = 'CD_COLIGADA'
    ...
    object qryCamposAdicionaisFormaPgtocd_forma_pgto: TLargeintField
      FieldName = 'cd_forma_pgto'
    end
  end
  object qryCamposAdicionaisCaixa: TUMZReadOnlyQuery
    Connection = DM.db
    SQL.Strings = (
      'SELECT'
      #9'fcc.cd_caixa'
      'FROM'
      #9'pessoas_cadastro pc'
      
        #9'INNER JOIN fin_cadastro_contas fcc ON (fcc.ds_caixa = pc.ds_con' +
        'teudo)'
      'WHERE'
      #9'pc.cd_pessoa = :CD_PESSOA AND'
      #9'pc.cd_campo = :CD_CAMPO')
    ...
    object qryCamposAdicionaisCaixacd_caixa: TIntegerField
      FieldName = 'cd_caixa'
    end
  end
end
