...
const
   SQL_BUSCA_LANCAMENTOS = ' SELECT '+
                           ...
                           ' 	  fcpc_cre.cd_conta = fc.cd_credito AND '+
                           '    fcpc_cre.cd_coligada_matriz = c.cd_coligada_matriz '+
                           '  ) '+
                           '  LEFT JOIN fin_config_plano_contas fcpc_deb ON ( '+
                           ' 	  fcpc_deb.cd_conta = fc.cd_debito AND '+
                           '    fcpc_deb.cd_coligada_matriz = c.cd_coligada_matriz '+
                           '  ) '+
...
begin
   ...
   // Trazer somente lançamentos vinculados a coligada que o usuário tem acesso
   qryLancamentos.SQL.Add( Separador + 'fc.cd_coligada IN ('+ DM.GetColigadas() + ') ');
