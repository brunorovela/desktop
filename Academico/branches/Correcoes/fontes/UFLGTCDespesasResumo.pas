...
type
   TfrmLGTCDespesasResumo = class(TForm)
    ...
    cdsDespesasCD_HISTORICO_CP: TIntegerField;
    cdsDespesasNR_DIAS_VENCIMENTO: TIntegerField;
    cdsContaPagarCD_HISTORICO: TIntegerField;
    cdsCompromissosCD_HISTORICO: TIntegerField;
    qryDespesasCD_HISTORICO_CP: TIntegerField;
    qryDespesasNR_DIAS_VENCIMENTO: TIntegerField;
    qryContaPagarCD_HISTORICO: TIntegerField;
...
begin
   ...
   begin
      ...
      begin
         ...
         cdsContaPagarCD_HISTORICO.AsInteger := cdsCompromissosCD_HISTORICO.AsInteger;
   ...
   begin
      ...
      begin
         ...
         begin
            ...
            cdsCompromissosDT_VENCIMENTO.AsDateTime := IncDay(cdsDespesasDT_AULA.AsDateTime, cdsDespesasNR_DIAS_VENCIMENTO.AsInteger);
            cdsCompromissosCD_HISTORICO.AsInteger := cdsDespesasCD_HISTORICO_CP.AsInteger;
