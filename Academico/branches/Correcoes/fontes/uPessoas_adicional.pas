...
type
  Tfrm_pessoas_adicional = class(TForm)
    ...
    qryGruposcd_pessoa: TIntegerField;
    qryGruposcd_coligada: TIntegerField;
    qryGruposcd_coligada_matriz: TIntegerField;
...
var
   qryExcluiPessoasMatriz,qryExcluiGrupos,qryAux: TUMZQuery;
   observacao,gruposExcluidos,cd_pessoa,cd_grupo,cd_coligada_matriz: String;
   i:integer;
begin
   if(Mensagem(
   ...
   begin
      ...
      cd_pessoa:= qryGruposcd_pessoa.AsString;
      cd_grupo:= qryGruposcd_grupo.AsString;
      cd_coligada_matriz:= qryGruposcd_coligada_matriz.AsString;
      ...
      DM.CriarConsulta(qryExcluiPessoasMatriz);
      qryExcluiPessoasMatriz.SQL.Text := ''
      + ' DELETE FROM '
      + '   nu_pessoas_matriz '
      + ' WHERE '
      + '   cd_pessoa = ' + cd_pessoa
      ...
      qryExcluiPessoasMatriz.ExecSQL;
      qryExcluiPessoasMatriz.Free;
      qryGrupos.Close;
      qryGrupos.Open;
