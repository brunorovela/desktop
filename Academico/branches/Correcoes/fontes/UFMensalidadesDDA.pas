...
const
   TextQ = 'Tem certeza que deseja enviar o pedido de cancelamento do Débito Automático para os boletos selecionados?';
   CaptionQ = 'Confirmação';
   TextD = 'O pedido de cancelamento do Débito Automático para os boletos selecionados foi registrado com sucesso.';
   CaptionD = 'Informação';
   TextQC = 'Tem certeza que deseja ignorar os boletos que possuem Débito Automático e continuar a impressão? Esses boletos não serão incluídos na impressão.';
var
   UserChoice: Integer;
   Remessa: TRemessa;
begin
