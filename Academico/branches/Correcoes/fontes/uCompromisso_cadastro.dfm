object frmCompromissoCadastro: TfrmCompromissoCadastro
      ...
      object Parcela: TTabSheet
        ...
        object ScrollBox1: TScrollBox
          ...
          object UMAjuda1: TUMAjuda
            ...
            Transparent = True
            Caption = 
              'Os abatimentos dever'#227'o ser aplicados pelo bot'#227'o Abatimentos, ap'#243 +
              's a gera'#231#227'o do compromisso.'
            Titulo = 'AJUDA'
          end
          ...
          object txtParValorAbatimento: TUMEditMonetario
            ...
            TabOrder = 5
            Text = '0,00'
            OnExit = txtParValorAbatimentoExit
            Mascara = '###,###,##0.00'
            CasasDecimais = 2
            EnterProximoCampo = True
          end
          object txtParValorDesconto: TUMEditMonetario
            ...
            TabOrder = 6
            Text = '0,00'
            OnExit = txtParValorDescontoExit
            Mascara = '###,###,##0.00'
            CasasDecimais = 2
            EnterProximoCampo = True
          end
          ...
          object edValorPagar: TUMEditMonetario
            Left = 445
            Top = 65
            Width = 104
            Height = 21
  ...
  object pnPgtoBoleto: TPanel
    ...
    object txtParBoletoCodigoBarras: TEdit
      ...
      MaxLength = 500
      TabOrder = 0
      OnChange = txtParBoletoCodigoBarrasChange
  ...
  object pnPgtoBoletoArrecadacao: TPanel
    ...
    object txtParBoletoCodigoBarrasArrecadacao: TEdit
      ...
      MaxLength = 500
      TabOrder = 0
      OnChange = txtParBoletoCodigoBarrasArrecadacaoChange
      OnEnter = txtParBoletoCodigoBarrasArrecadacaoEnter
  ...
  object qryAnexosParc: TUMZQuery
    ...
    object qryAnexosParcDS_EXTENSAO: TStringField
      FieldName = 'DS_EXTENSAO'
      Size = 255
    end
  end
  ...
  object updAnexosParc: TZUpdateSQL
    ...
    InsertSQL.Strings = (
      ...
      '   (CD_TITULO, CD_COLIGADA, DT_INCLUSAO, BB_ANEXO, DS_EXTENSAO)'
      'VALUES'
      '   (:CD_TITULO, :CD_COLIGADA, NOW(), :BB_ANEXO, :DS_EXTENSAO)')
    ModifySQL.Strings = (
  ...
  object qryFinanceiro: TUMZQuery
    Connection = DM.db
    SQL.Strings = (
      'SELECT'
      'C.VL_CREDITO'
      ...
      'JOIN FIN_MOV_CP MC ON'
      '(MC.cd_titulo = M.CD_TITULO )'
      ''
      'WHERE'
      'M.CD_PESSOA = :CD_PESSOA'
      'GROUP BY'
      'MC.CD_TITULO'
      'ORDER BY M.CD_TITULO DESC LIMIT 1')
    Params = <
      item
        DataType = ftInteger
        Name = 'CD_PESSOA'
    ...
    object qryFinanceirovl_credito: TFloatField
