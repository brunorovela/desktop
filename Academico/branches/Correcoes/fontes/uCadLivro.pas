...
begin
   ...
   begin
      ...
      Self.qyInsereLivro.ParamByName('nr_ultimo_cert_registro').AsInteger := Self.qyUltimoNrRegistro.FieldByName('nr_ultimo_cert_registro').AsInteger;
