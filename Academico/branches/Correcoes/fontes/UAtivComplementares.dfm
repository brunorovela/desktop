object frmAtivComplementares: TfrmAtivComplementares
    ...
    object tsCadAtividades: TTabSheet
      ...
      object pnCadAtivEsq: TPanel
        ...
        object Label11: TLabel
          ...
          Width = 129
          Height = 13
          Caption = 'Horas m'#225'xima do semestre'
          FocusControl = dbAtividadesHrSemestre
        end
        object Label12: TLabel
          ...
          Caption = 
            'Obs.: Total de horas que o aluno pode possuir nessa atividade ao' +
            ' longo do semestre. (validado pelo sistema)'
          FocusControl = dbAreaHoras
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          Font.Height = -11
        ...
        object dbAtividadesHrSemestre: TDBEdit
          Left = 16
          Top = 470
          Width = 133
          Height = 21
          DataField = 'nr_horas_etapa'
          DataSource = dsAtividades
          MaxLength = 3
          TabOrder = 6
          OnKeyPress = dbAtividadesHrSemestreKeyPress
        end
      end
      object pnCadAtivDir: TPanel
        ...
        object dbgrdAtividades: TDBGrid
          ...
          Columns = <
            ...
            item
              Expanded = False
              FieldName = 'nr_horas_etapa'
              Title.Caption = 'Horas por semestre'
              Width = 99
              Visible = True
            end
            item
  ...
  object dsAreas: TDataSource
    DataSet = qyAreas
    OnStateChange = dsAreasStateChange
  ...
  object qyGrupos: TUMZQuery
    ...
    object qyGrupossn_estagio: TSmallintField
      FieldName = 'sn_estagio'
    end
  end
  ...
  object qyAtividades: TUMZQuery
    ...
    object qyAtividadesnr_horas_etapa: TFloatField
      FieldName = 'nr_horas_etapa'
    end
