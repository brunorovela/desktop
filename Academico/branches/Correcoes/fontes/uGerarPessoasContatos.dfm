object uFGerarPessoaContatos: TuFGerarPessoaContatos
  Left = 0
  Top = 0
  Caption = 'Gerar Cadastro'
  ClientHeight = 132
  ClientWidth = 409
  Color = clBtnFace
  ...
  object dsPessoasContatos: TDataSource
    Left = 440
    Top = 184
  end
  object qyBuscaCadastro: TUMZQuery
  ...
  object dsBuscaCadastro: TDataSource
    DataSet = qyBuscaCadastro
    Left = 192
    Top = 48
  end
end
