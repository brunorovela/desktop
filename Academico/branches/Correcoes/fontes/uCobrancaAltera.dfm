object frmCobrancaAltera: TfrmCobrancaAltera
  ...
  object qyResposaveis: TUMZQuery
    ...
    SQL.Strings = (
      ...
      'WHERE '
        ...
        '   (US.SN_BLOQUEADO != 1 AND COALESCE(NGP.NR_PERMISSAO,0) != 0) ' +
        'AND'
  ...
  object updCobranca: TZUpdateSQL
    ModifySQL.Strings = (
      'UPDATE FIN_COBRANCA SET'
      '  dt_registro = :dt_registro,'
      '  cd_situacao = :cd_situacao,'
      '  sn_spc = :sn_spc,'
      '  dt_spc_inclusao = :dt_spc_inclusao,'
      '  dt_spc_retirada = :dt_spc_retirada,'
      '  sn_juridico = :sn_juridico,'
      '  dt_juridico_inclusao = :dt_juridico_inclusao,'
      '  dt_juridico_retirada = :dt_juridico_retirada,'
      '  cd_responsavel = :cd_responsavel,'
      '  dt_retorno = :dt_retorno,'
      '  SN_SERASA = :SN_SERASA,'
      '  dt_serasa_inclusao = :dt_serasa_inclusao,'
      '  dt_serasa_retirada = :dt_serasa_retirada,'
      '  sn_cartorio = :sn_cartorio,'
      '  dt_cartorio_inclusao = :dt_cartorio_inclusao,'
      '  dt_cartorio_retirada = :dt_cartorio_retirada'
      'WHERE'
      '  FIN_COBRANCA.cd_cobranca = :OLD_cd_cobranca')
    ...
    ParamData = <
      ...
      item
        DataType = ftUnknown
        Name = 'dt_spc_inclusao'
        ParamType = ptUnknown
      end
      item
        DataType = ftUnknown
        Name = 'dt_spc_retirada'
        ParamType = ptUnknown
      end
      item
        DataType = ftUnknown
      ...
      item
        DataType = ftUnknown
        Name = 'dt_juridico_inclusao'
        ParamType = ptUnknown
      end
      item
        DataType = ftUnknown
        Name = 'dt_juridico_retirada'
        ParamType = ptUnknown
      end
      item
        DataType = ftUnknown
      ...
      item
        DataType = ftUnknown
        Name = 'dt_serasa_inclusao'
        ParamType = ptUnknown
      end
      item
        DataType = ftUnknown
        Name = 'dt_serasa_retirada'
        ParamType = ptUnknown
      end
      item
        DataType = ftUnknown
      ...
      item
        DataType = ftUnknown
        Name = 'dt_cartorio_inclusao'
        ParamType = ptUnknown
      end
      item
        DataType = ftUnknown
        Name = 'dt_cartorio_retirada'
        ParamType = ptUnknown
      end
      item
        DataType = ftUnknown
        Name = 'OLD_cd_cobranca'
        ParamType = ptUnknown
      end>
  end
end
