...
type
  Tfrm_Avaliacoes_parametros = class(TForm)
    ...
    qyProvasUsadassn_considerar_participacao: TSmallintField;
    qyProvasUsadassn_ocultar_prova_aluno: TSmallintField;
    DBCheckBox55: TDBCheckBox;
    DBCheckBox56: TDBCheckBox;
    DBEdit37: TDBEdit;
    Label72: TLabel;
    tblAvaliacoesds_nome_atividade: TStringField;
    tblAvaliacoesds_condicao_digitar_re: TStringField;
    Label73: TLabel;
    DBEdit38: TDBEdit;
