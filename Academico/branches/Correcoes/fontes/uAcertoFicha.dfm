object frmAcertoFicha: TfrmAcertoFicha
  ...
  object Panel1: TPanel
    ...
    object pnNotas: TPanel
      ...
      object pnAvaliacao1: TPanel
        ...
        object edFaltaJustificada1: TEdit
          Tag = 1
          Left = 494
          Top = 3
          Width = 30
          Height = 22
          TabOrder = 4
          OnExit = edFaltaAtualizarTotalExit
          OnKeyDown = dbFalta1KeyDown
          OnKeyPress = dbFalta1KeyPress
        end
        object edFaltaInjustificada1: TEdit
          Tag = 1
          Left = 534
          Top = 3
          Width = 30
      ...
      object pnAvaliacao2: TPanel
        ...
        object edFaltaInjustificada2: TEdit
          Tag = 2
          Left = 534
          Top = 3
          Width = 30
        ...
        object edFaltaJustificada2: TEdit
          Tag = 2
          Left = 494
          Top = 3
          Width = 30
      ...
      object pnAvaliacao3: TPanel
        ...
        object edFaltaJustificada3: TEdit
          Tag = 3
          Left = 494
          Top = 3
          Width = 30
        ...
        object edFaltaInjustificada3: TEdit
          Tag = 3
          Left = 534
          Top = 2
          Width = 30
      ...
      object pnAvaliacao4: TPanel
        ...
        object edFaltaJustificada4: TEdit
          Tag = 4
          Left = 494
          Top = 3
          Width = 30
        ...
        object edFaltaInjustificada4: TEdit
          Tag = 4
          Left = 534
          Top = 3
          Width = 30
      ...
      object pnAvaliacao5: TPanel
        ...
        object edFaltaJustificada5: TEdit
          Tag = 5
          Left = 494
          Top = 3
          Width = 30
        ...
        object edFaltaInjustificada5: TEdit
          Tag = 5
          Left = 534
          Top = 3
          Width = 30
      ...
      object pnAvaliacao6: TPanel
        ...
        object edFaltaJustificada6: TEdit
          Tag = 6
          Left = 494
          Top = 3
          Width = 30
        ...
        object edFaltaInjustificada6: TEdit
          Tag = 6
          Left = 534
          Top = 3
          Width = 30
      ...
      object pnAvaliacao7: TPanel
        ...
        object edFaltaJustificada7: TEdit
          Tag = 7
          Left = 494
          Top = 3
          Width = 30
        ...
        object edFaltaInjustificada7: TEdit
          Tag = 7
          Left = 534
          Top = 3
          Width = 30
      ...
      object pnAvaliacao8: TPanel
        ...
        object edFaltaJustificada8: TEdit
          Tag = 8
          Left = 494
          Top = 3
          Width = 30
        ...
        object edFaltaInjustificada8: TEdit
          Tag = 8
          Left = 534
          Top = 3
          Width = 30
      ...
      object pnAvaliacao9: TPanel
        ...
        object edFaltaJustificada9: TEdit
          Tag = 9
          Left = 494
          Top = 3
          Width = 30
        ...
        object edFaltaInjustificada9: TEdit
          Tag = 9
          Left = 534
          Top = 3
          Width = 30
      ...
      object pnAvaliacao10: TPanel
        ...
        object edFaltaJustificada10: TEdit
          Tag = 10
          Left = 494
          Top = 3
          Width = 30
        ...
        object edFaltaInjustificada10: TEdit
          Tag = 10
          Left = 534
          Top = 3
          Width = 30
  ...
  object qryAulasJustificadas: TUMZQuery
    Connection = DM.db
    SQL.Strings = (
      'SELECT'
      #9'nr_etapa,'
      '  nr_faltas'
      'FROM'
      #9'ficha_faltas_justificadas'
      'WHERE'
      #9'nr_anosemestre = :nr_anosemestre AND'
      #9'cd_turma LIKE :cd_turma AND'
      #9'cd_pessoa = :cd_pessoa AND'
      #9'cd_disciplina = :cd_disciplina AND'
      #9'nr_serie = :nr_serie AND'
      #9'nr_etapa = :nr_etapa')
    Params = <
      item
        DataType = ftUnknown
    ...
    object qryAulasJustificadasnr_etapa: TIntegerField
      FieldName = 'nr_etapa'
    end
    object qryAulasJustificadasnr_faltas: TIntegerField
      FieldName = 'nr_faltas'
    end
  end
  object qryParametroFaltaJustificada: TUMZQuery
    Connection = DM.db
    SQL.Strings = (
      'SELECT'
      #9'apm.sn_faltas_justificadas'
      'FROM'
      '  turmas t'
        ...
        'ND gd.cd_curso = t.curso AND gd.nr_serie = t.serie)'
    ...
    object qryParametroFaltaJustificadasn_faltas_justificadas: TSmallintField
      FieldName = 'sn_faltas_justificadas'
    end
  end
  object qrySalvarFaltasJustificadas: TUMZQuery
    Connection = DM.db
    SQL.Strings = (
