object fMatricularDivisaoTitulos: TfMatricularDivisaoTitulos
  ...
  object qryDivisaoProgramada: TUMZReadOnlyQuery
    ...
    SQL.Strings = (
      ...
      '   P.CD_TIPO_TITULO,'
      '   P.CD_COLIGADA_MATRIZ,'
      '   P.SN_ALTERAR_TIPO_TITULO,'
      '   P.SN_ALTERAR_VENCTO,'
      '   P.DT_VENCTO_INICIAL,'
      '   T.DS_TIPO_TITULO,'
      '   P.SN_DIVIDIR_DESCONTO_CONDICIONAL'
      'FROM'
      '   PESSOAS_DESCONTOS P'
      ''
      '      LEFT JOIN FIN_CONFIG_TIPOS_TITULO T ON'
      '        (P.CD_TIPO_TITULO = T.CD_TIPO_TITULO) AND'
      '        (P.CD_COLIGADA_MATRIZ = T.CD_COLIGADA_MATRIZ)'
      ''
      '      JOIN PESSOAS R ON'
    ...
    object qryDivisaoProgramadaCD_TIPO_TITULO: TIntegerField
      FieldName = 'CD_TIPO_TITULO'
    end
    object qryDivisaoProgramadaCD_COLIGADA_MATRIZ: TIntegerField
      FieldName = 'CD_COLIGADA_MATRIZ'
    end
    object qryDivisaoProgramadaSN_ALTERAR_TIPO_TITULO: TSmallintField
      FieldName = 'SN_ALTERAR_TIPO_TITULO'
      Required = True
    end
    object qryDivisaoProgramadaSN_ALTERAR_VENCTO: TSmallintField
      FieldName = 'SN_ALTERAR_VENCTO'
      Required = True
    end
    object qryDivisaoProgramadaDT_VENCTO_INICIAL: TDateField
      FieldName = 'DT_VENCTO_INICIAL'
    end
    object qryDivisaoProgramadaDS_TIPO_TITULO: TStringField
      FieldName = 'DS_TIPO_TITULO'
      Size = 255
    end
    object qryDivisaoProgramadaSN_DIVIDIR_DESCONTO_CONDICIONAL: TSmallintField
