...
begin
   if ( qryCentroSimples.Filtered ) then
   begin
...
begin
   ...
   pos1 := Pos( '*',  qryCentroSimples.Filter )+1;
   pos2 := LastDelimiter('*',  qryCentroSimples.Filter);

   pos2 := pos2-pos1;

   ds_descricao_centro := Copy(
      qryCentroSimples.Filter,
      pos1,
      pos2
   );

   edDescSimples.Text := ds_descricao_centro;
   qryCentroSimples.Filtered := False;
   Button3Click( nil );
end;
