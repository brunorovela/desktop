      ...
      object ScrollBox2: TScrollBox
        ...
        object pgConta: TPageControl
          ...
          object TabSheet4: TTabSheet
            ...
            object UMAjuda_juros_mensal: TUMAjuda
              Left = 247
              Top = 53
              Picture.Data = {
                07544269746D6170F6060000424DF60600000000000036000000280000001800
              ...
              Transparent = True
              Caption = 
                'Informe o percentual de juros mensal que deve ser aplicado no ca' +
                'so de atraso de pagamento dos t'#237'tulos.'#13#10#13#10'[b]Importante:[b] O pe' +
                'rcentual '#233' informado mensal, mas a aplica'#231#227'o '#233' di'#225'ria.'#13#10#13#10'[b]Ex.' +
                ':[b] 1% ao m'#234's.'#13#10#13#10'Para este caso, o sistema divide este percent' +
                'ual por 30 dias e faz a aplica'#231#227'o deste valor a cada dia de atra' +
                'so do aluno.'
              Titulo = '% de juros mensal'
            end
            object UMAjuda_juros_mes: TUMAjuda
              Left = 399
              Top = 53
              Picture.Data = {
                07544269746D6170F6060000424DF60600000000000036000000280000001800
              ...
              Caption = 
                'Informe o percentual de juros mensal que deve ser aplicado no ca' +
                'so de atraso de pagamento dos t'#237'tulos.'#13#10#13#10'[b]Importante:[b] O pe' +
                'rcentual informado nesta op'#231#227'o '#233' aplicado a cada 30 dias de atra' +
                'so da mensalidade.'#13#10#13#10'[b]Ex.:[b] 2% ao m'#234's.'
              Titulo = '% de juros ao m'#234's'
            end
            object UMAjuda3: TUMAjuda
              Left = 347
              Top = 132
              Picture.Data = {
                07544269746D6170F6060000424DF60600000000000036000000280000001800
              ...
              Transparent = True
              Caption = 
                'Informe a quantidade de dias que, ap'#243's o vencimento da parcela, ' +
                'a institui'#231#227'o ainda ir'#225' considerar o desconto informado no campo' +
                ' "%Desc. Car'#234'ncia".'#13#10#13#10'[b]%Desc. Car'#234'ncia[b]'#13#10'Informe o novo per' +
                'centual de desconto dentro da car'#234'ncia informada em "Car'#234'ncia de' +
                ' Desconto".'#13#10#13#10'[b]Ex.:[b] O Aluno possui 10% de desconto at'#233' o v' +
                'encimento. Caso informado 2 dias no campo "Car'#234'ncia de desconto"' +
                ' e'#13#10'5% no campo "%Desc. Car'#234'ncia", o sistema ir'#225' considerar 5% d' +
                'e desconto ainda por aluno por mais 2 dias ap'#243's a data de vencim' +
                'ento.'
              Titulo = 'Car'#234'ncia de desconto'
            end
