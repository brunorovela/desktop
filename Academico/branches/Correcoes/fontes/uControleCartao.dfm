object frmControleCartao: TfrmControleCartao
  ...
  object qyControleCartao: TUMZQuery
    ...
    SQL.Strings = (
      ...
      #9'fco.nr_taxa,'
        ...
        #9' IF ( ROUND( (fco.nr_taxa * fcp.vl_valor_parcela / 100) , 2) < ' +
        'IFNULL(fcac.vl_min_operacao,0) AND ROUND( (fco.nr_taxa ) , 2) > ' +
        '0  '
      '          , IFNULL(fcac.vl_min_operacao,0)  '
      
        '          , ROUND( (fco.nr_taxa * fcp.vl_valor_parcela / 100) , ' +
        '2) '
      '          ) AS tarifa, '
      '          '
      '       ROUND( (fcp.vl_valor_parcela) - '
      
        '          IF ( ROUND( (fco.nr_taxa * fcp.vl_valor_parcela / 100)' +
        ' , 2) < IFNULL(fcac.vl_min_operacao,0) AND ROUND( (fco.nr_taxa )' +
        ' , 2) > 0  '
      '          , IFNULL(fcac.vl_min_operacao,0)  '
    ...
    object qyControleCartaodt_baixa: TDateTimeField
      Tag = 1
  ...
  object cdsControleCartao: TClientDataSet
    ...
    object cdsControleCartaodt_baixa: TDateTimeField
      FieldName = 'dt_baixa'
    end
  end
