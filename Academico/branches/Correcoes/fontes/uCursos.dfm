object frmCursos: TfrmCursos
        ...
        object Panel13: TPanel
          ...
          object pgTurmas: TPageControl
            ...
            object TabSheet10: TTabSheet
              ...
              object LabelProxTurmaReprMesmoCurso: TLabel
                Left = 12
                Top = 134
                Width = 135
                Height = 14
                Caption = 'Pr'#243'xima turma (Reprovada):'
              end
              ...
              object dbcbProxTurmaMesmoAnosemestre: TDBCheckBox
                Left = 11
                Top = 69
                Width = 353
                Height = 17
                Hint = 
                  'Indica que a pr'#243'xima turma escolhida '#233' do mesmo ano/semestre da ' +
                  'turma selecionada.'
                Caption = 'Pr'#243'xima turma no mesmo ano/semestre'
                DataField = 'sn_matricula_mesmo_anosem'
                DataSource = dtcTurmas
                TabOrder = 4
                ValueChecked = '1'
                ValueUnchecked = '0'
                OnClick = dbcbProxTurmaMesmoAnosemestreClick
              end
              object dbcbProximaTurmaRepr: TDBLookupComboBox
                Left = 12
                Top = 146
                Width = 357
                Height = 22
                DataField = 'cd_proxima_turma_repr_lk'
                DataSource = dtcTurmas
                TabOrder = 5
              end
            end
          ...
          object Panel23: TPanel
            ...
            object ScrollBox1: TScrollBox
              ...
              object dbchTurmaEspecial: TDBCheckBox
                ...
                Height = 17
                Hint = 
                  'Faz com que a turma n'#227'o seja considerada na avalia'#231#227'o institucio' +
                  'nal.'
                Caption = 'Essa turma n'#227'o realiza avalia'#231#227'o institucional'
              ...
              object dbckbSN_ATIVA: TDBCheckBox
                Left = 16
                Top = 255
                Width = 353
                Height = 17
                ...
                object ts1ProfessorResponsavel: TTabSheet
                  ...
                  object spResp1: TSpeedButton
                    ...
                    Glyph.Data = {
                      ...
                      333333773FF77333333333370007333333333333777333333333}
                    NumGlyphs = 2
                    OnClick = spResp1Click
                  end
                  object DBEditResp1: TDBEdit
                    Left = 1
                    Top = 15
                    Width = 81
                    Height = 22
                    DataField = 'professor_responsavel'
                    DataSource = dtcTurmas
                    TabOrder = 0
                  end
                  object txtResponsavelTurma1: TEdit
                    Left = 88
                    Top = 16
                    Width = 235
                    Height = 22
                ...
                object ts2ProfessorResponsavel: TTabSheet
                  ...
                  object spResp2: TSpeedButton
                    ...
                    Glyph.Data = {
                      ...
                      333333773FF77333333333370007333333333333777333333333}
                    NumGlyphs = 2
                    OnClick = spResp2Click
                  end
                  object DBEditResp2: TDBEdit
                    Left = 0
                    Top = 15
                    Width = 83
                    Height = 22
                    DataField = 'professor_responsavel2'
                    DataSource = dtcTurmas
                    TabOrder = 0
                  end
                  object txtResponsavelTurma2: TEdit
                    Left = 89
                    Top = 16
                    Width = 235
                    Height = 22
            ...
            object Panel24: TPanel
              ...
              object pcEmenta: TPageControl
                ...
                object tbsJustificativa: TTabSheet
                  ...
                  ImageIndex = 5
                  object dbreJustificativa: TDBRichEdit
                    Left = 0
                    Top = 0
                    Width = 355
                    Height = 353
        ...
        object Panel2: TPanel
          ...
          object grdGrade: TDBGrid
            ...
            Columns = <
              ...
              item
                Expanded = False
                FieldName = 'DS_AJUSTE_REMATRICULA'
                Visible = True
              end>
          end
          ...
          object blementa: TToolBar
            ...
            object btnPreRequisitoEspecial: TToolButton
              ...
              ImageIndex = 2
              OnClick = btnPreRequisitoEspecialClick
            end
            object btnDataLimiteMatricula: TToolButton
              Left = 656
              Top = 0
              Caption = 'Definir data limite'
              ImageIndex = 6
              OnClick = btnDataLimiteMatriculaClick
            end
          end
          ...
          object cbAjusteRematricula: TUMComboBox
            Left = 704
            Top = 166
            Width = 145
            Height = 20
            ...
            TabOrder = 8
            Visible = False
            OnChange = cbAjusteRematriculaChange
            Items.Strings = (
              'Sim'
              'N'#227'o')
            TamanhoMaximo = 0
        ...
        object Panel5: TPanel
          ...
          object pnCadastroGrade: TPanel
            ...
            object Label68: TLabel
              ...
              Width = 93
              Height = 28
              Caption = 'Percentual m'#225'ximo de reprova'#231#227'o:'
              WordWrap = True
            end
            ...
            object dbePercMaxReprovacao: TDBEdit
              Left = 107
              Top = 210
              Width = 179
              Height = 22
              DataField = 'NR_PERC_MAX_REPROVACAO'
              DataSource = dsGrades
              TabOrder = 8
            end
  ...
  object tblTurmas: TUMZQuery
    Connection = DM.db
    BeforeOpen = tblTurmasBeforeOpen
    AfterOpen = tblTurmasAfterOpen
    ...
    object tblTurmassn_matricula_mesmo_anosem: TSmallintField
      FieldName = 'sn_matricula_mesmo_anosem'
    end
    object tblTurmascd_proxima_turma_repr_lk: TStringField
      FieldKind = fkLookup
      FieldName = 'cd_proxima_turma_repr_lk'
      LookupDataSet = qyListaProximaTurmaRepr
      LookupKeyFields = 'codigo'
      LookupResultField = 'codigo'
      KeyFields = 'cd_proxima_turma_repr'
      Lookup = True
    end
    object tblTurmascd_proxima_turma_repr: TStringField
      FieldName = 'cd_proxima_turma_repr'
      Origin = 'WMESTRE12.turmas.cd_proxima_turma_repr'
    end
  end
  ...
  object tblDisc: TUMZQuery
    ...
    object tblDiscsn_ativo: TSmallintField
      FieldName = 'sn_ativo'
    end
    object tblDiscid_disciplina: TLargeintField
  ...
  object tblEmentas: TUMZQuery
    ...
    object tblEmentasME_JUSTIFICATIVA: TBlobField
      FieldName = 'ME_JUSTIFICATIVA'
    end
    object tblEmentasTX_JUSTIFICATIVA_HTML: TMemoField
      FieldName = 'TX_JUSTIFICATIVA_HTML'
      BlobType = ftMemo
    end
    object tblEmentasME_HABILIDADES_COMPET: TBlobField
      FieldName = 'ME_HABILIDADES_COMPET'
    end
    object tblEmentasTX_HABILIDADES_COMPET_HTML: TMemoField
  ...
  object qyAtosOficiais: TUMZQuery
    ...
    object qyAtosOficiaiscd_unidade_certificadora: TIntegerField
      FieldName = 'cd_unidade_certificadora'
    end
  end
  ...
  object qyGrades: TUMZQuery
    ...
    SQLList.Strings = (
        ...
        'oracle=SELECT'#13#10'  id,'#13#10'  CD_GRADE,'#13#10'  CD_CURSO,'#13#10'  DS_GRADE,'#13#10'  N' +
        'R_ANO_INICIAL,'#13#10'  SN_ATIVO,'#13#10'  NR_CARGA_CURSO,'#13#10'  NR_CARGA_ATIVI' +
        'DADES'#13#10'  SN_PADRAO'#13#10'FROM'#13#10'  GRADES'#13#10'WHERE'#13#10'  CD_CURSO = :CD_CURS' +
        'O AND SN_ATIVO = '#39'S'#39'  '#13#10'ORDER BY'#13#10'  CD_GRADE, DS_GRADE'
      
        'mysql-5=SELECT'#13#10'  id,'#13#10'  CD_GRADE,'#13#10'  CD_CURSO,'#13#10'  DS_GRADE,'#13#10'  ' +
        'NR_ANO_INICIAL,'#13#10'  SN_ATIVO,'#13#10'  NR_CARGA_CURSO,'#13#10'  NR_CARGA_ATIV' +
        'IDADES,'#13#10'  SN_PADRAO,'#13#10'  NR_PERC_MAX_REPROVACAO'#13#10'FROM'#13#10'  GRADES'#13 +
        #10'WHERE'#13#10'  CD_CURSO = :CD_CURSO AND SN_ATIVO = '#39'S'#39'  '#13#10'ORDER BY'#13#10' ' +
        ' CD_GRADE, DS_GRADE')
    Left = 770
    Top = 524
    ParamData = <
    ...
    object qyGradesID: TLargeintField
      FieldName = 'id'
    end
    ...
    object qyGradesNR_PERC_MAX_REPROVACAO: TFloatField
      FieldName = 'NR_PERC_MAX_REPROVACAO'
    end
  end
  ...
  object qyGradesDisciplinas: TUMZQuery
    ...
    SQL.Strings = (
      ...
      '  GD.*, '
        ...
        '  CASE WHEN GD.SN_EXTRA = 1 THEN '#39'Sim'#39' ELSE '#39'N'#227'o'#39' END AS DS_EXTR' +
        'A,'
      
        '  CASE WHEN GD.SN_AJUSTE_REMATRICULA = 1 THEN '#39'Sim'#39' ELSE '#39'N'#227'o'#39' E' +
        'ND AS DS_AJUSTE_REMATRICULA,'
      '  D.SIGLA,'
      '  D.DESCRICAO,'
      '  AP.DS_AVALIACAO,'
      '  CASE'
    ...
    SQLList.Strings = (
        ...
        'mysql-5=SELECT'#13#10'   GD.CD_GRADE,'#13#10'   GD.DT_LIMITE,'#13#10'   GD.CD_CURS' +
        'O,'#13#10'   GD.CD_DISCIPLINA,'#13#10'   GD.NR_CH_TEORICA_PRATICA,'#13#10'   GD.NR' +
        '_SERIE,'#13#10'   CASE WHEN GD.SN_AJUSTE_REMATRICULA = 1 THEN '#39'Sim'#39' EL' +
        'SE '#39'N'#227'o'#39' END AS DS_AJUSTE_REMATRICULA,   '#13#10'   CASE WHEN GD.NR_SE' +
        'RIE = -100 THEN '#39'OPT'#39' ELSE GD.NR_SERIE END DS_SERIE,'#13#10'   GD.NR_A' +
        'ULAS,'#13#10'   GD.VL_VALOR,'#13#10'   GD.SN_COMPARTILHADA,'#13#10'   GD.NR_CREDIT' +
        'OS_ACADEMICOS,'#13#10'   GD.CD_DISCIPLINA_CATEGORIA,'#13#10'   GD.NR_CARGA_H' +
        'ORARIA_PRATICA,'#13#10'   GD.NR_CARGA_HORARIA_TEORICA,'#13#10'   GD.CD_AVALI' +
        'ACAO,'#13#10'   GD.SN_EXTRA,'#13#10'   GD.NR_QTD_DIAS_INICIO_MOODLE,'#13#10'   CAS' +
        'E WHEN GD.SN_EXTRA = 1 THEN '#39'Sim'#39' ELSE '#39'N'#227'o'#39' END AS DS_EXTRA, '#13#10 +
        '   D.SIGLA, '#13#10'   D.DESCRICAO,'#13#10'   AP.DS_AVALIACAO,'#13#10'   GD.SN_OPT' +
        'ATIVA,'#13#10'   CASE WHEN GD.SN_OPTATIVA = 1 THEN '#39'Sim'#39' ELSE '#39'N'#227'o'#39' EN' +
        'D AS DS_OPTATIVA,'#13#10'   GD.CD_DISCIPLINA_FRENTE,'#13#10'   COALESCE(D2.D' +
        'ESCRICAO, '#39#39') AS DS_DISCIPLINA_FRENTE,'#13#10'   CASE WHEN (SELECT COU' +
        'NT(*) AS registro FROM DISCIPLINAS_PREREQ DPR WHERE DPR.cd_curso' +
        ' = GD.CD_CURSO AND DPR.cd_discipli = GD.CD_DISCIPLINA AND DPR.cd' +
        '_grade = GD.CD_GRADE) > 0 THEN'#13#10'      '#39'X'#39#13#10'   ELSE'#13#10'      '#39#39#13#10'  ' +
        ' END AS PRE_REQUISITO,'#13#10'   CASE WHEN (SELECT COUNT(*) AS registr' +
        'o FROM DISCIPLINAS_PREREQ_ESPECIAL DPRE WHERE DPRE.cd_curso = GD' +
        '.CD_CURSO AND DPRE.cd_disciplina = GD.CD_DISCIPLINA AND DPRE.cd_' +
        'grade = GD.CD_GRADE) > 0 THEN'#13#10'      '#39'X'#39#13#10'   ELSE'#13#10'      '#39#39#13#10'   ' +
        'END AS PRE_REQUISITO_ESPECIAL,'#13#10'   GD.SN_AJUSTE_REMATRICULA'#13#10'FRO' +
        'M'#13#10'  GRADES G'#13#10'  INNER JOIN GRADES_DISCIPLINAS GD ON (GD.CD_GRAD' +
        'E = G.CD_GRADE AND GD.CD_CURSO = G.CD_CURSO)'#13#10'  INNER JOIN DISCI' +
        'PLINAS D ON (D.CODIGO = GD.CD_DISCIPLINA AND D.CURSO = GD.CD_CUR' +
        'SO)'#13#10'  LEFT JOIN AVALIACOES_PARAMETROS AP ON (AP.CD_AVALIACAO = ' +
        'GD.CD_AVALIACAO)'#13#10'  LEFT JOIN DISCIPLINAS D2 ON (D2.CODIGO = GD.' +
        'CD_DISCIPLINA_FRENTE AND D2.CURSO = GD.CD_CURSO)'#13#10'WHERE'#13#10'  G.CD_' +
        'GRADE = :CD_GRADE AND'#13#10'  G.CD_CURSO = :CD_CURSO'#13#10'ORDER BY'#13#10'  CAS' +
        'E WHEN GD.NR_SERIE = -100 THEN 99999 ELSE GD.NR_SERIE END, D.DES' +
        'CRICAO;'
      
        'oracle=SELECT'#13#10'   GD.CD_GRADE,'#13#10'   GD.DT_LIMITE,'#13#10'   GD.CD_CURSO' +
        ','#13#10'   GD.CD_DISCIPLINA,'#13#10'   GD.NR_SERIE,'#13#10'   GD.NR_AULAS,'#13#10'   GD' +
        '.VL_VALOR,'#13#10'   GD.SN_COMPARTILHADA,'#13#10'   GD.NR_CREDITOS_ACADEMICO' +
        'S,'#13#10'   GD.CD_DISCIPLINA_CATEGORIA,'#13#10'   GD.NR_CARGA_HORARIA_PRATI' +
        'CA,'#13#10'   GD.NR_CARGA_HORARIA_TEORICA,'#13#10'   GD.CD_AVALIACAO,'#13#10'   GD' +
        '.SN_EXTRA,     '#13#10'   GD.NR_QTD_DIAS_INICIO_MOODLE,'#13#10'   CASE WHEN ' +
        'GD.SN_EXTRA = 1 THEN '#39'Sim'#39' ELSE '#39'N'#227'o'#39' END AS DS_EXTRA, '#13#10'   D.SI' +
        'GLA, '#13#10'   D.DESCRICAO,'#13#10'   AP.DS_AVALIACAO,'#13#10'   CASE WHEN (SELEC' +
        'T COUNT(*) AS registro FROM DISCIPLINAS_PREREQ DPR WHERE DPR.cd_' +
        'curso = GD.CD_CURSO AND DPR.cd_discipli = GD.CD_DISCIPLINA AND D' +
        'PR.cd_grade = GD.CD_GRADE) > 0 THEN'#13#10'      '#39'X'#39#13#10'   ELSE'#13#10'      '#39 +
        #39#13#10'   END AS PRE_REQUISITO,'#13#10'   CASE WHEN (SELECT COUNT(*) AS re' +
        'gistro FROM DISCIPLINAS_PREREQ_ESPECIAL DPRE WHERE DPRE.cd_curso' +
        ' = GD.CD_CURSO AND DPRE.cd_disciplina = GD.CD_DISCIPLINA AND DPR' +
        'E.cd_grade = GD.CD_GRADE) > 0 THEN'#13#10'      '#39'X'#39#13#10'   ELSE'#13#10'      '#39#39 +
        #13#10'   END AS PRE_REQUISITO_ESPECIAL'#13#10'FROM'#13#10'  GRADES G'#13#10'  INNER JO' +
        'IN GRADES_DISCIPLINAS GD ON (GD.CD_GRADE = G.CD_GRADE AND GD.CD_' +
        'CURSO = G.CD_CURSO)'#13#10'  INNER JOIN DISCIPLINAS D ON (D.CODIGO = G' +
        'D.CD_DISCIPLINA AND D.CURSO = GD.CD_CURSO)'#13#10'  LEFT JOIN AVALIACO' +
        'ES_PARAMETROS AP ON (AP.CD_AVALIACAO = GD.CD_AVALIACAO)'#13#10'WHERE'#13#10 +
        '  G.CD_GRADE = :CD_GRADE AND'#13#10'  G.CD_CURSO = :CD_CURSO'#13#10'ORDER BY' +
        #13#10'  GD.NR_SERIE')
    Left = 770
    Top = 556
    ParamData = <
    ...
    object qyGradesDisciplinasSN_AJUSTE_REMATRICULA: TSmallintField
      FieldName = 'SN_AJUSTE_REMATRICULA'
    end
    object qyGradesDisciplinasDS_AJUSTE_REMATRICULA: TStringField
      Tag = 1
      DisplayLabel = 'Ajuste rematr'#237'cula'
      FieldName = 'DS_AJUSTE_REMATRICULA'
      ReadOnly = True
      Size = 3
    end
    object qyGradesDisciplinasDT_LIMITE: TDateTimeField
      Tag = 1
  ...
  object qyListaGrades: TUMZQuery
    ...
    SQLList.Strings = (
        ...
        'CD_CURSO'#13#10'  AND sn_ativo = '#39'S'#39#13#10'ORDER BY'#13#10'  cd_grade DESC')
    Left = 336
    Top = 152
    ParamData = <
      item
  ...
  object tmSelecaoCurso: TTimer
    Enabled = False
    Interval = 1500
    OnTimer = tmSelecaoCursoTimer
    Left = 24
    Top = 520
  end
  object tmSelecaoColigada: TTimer
    Enabled = False
    Interval = 1500
    OnTimer = tmSelecaoColigadaTimer
    Left = 144
    Top = 168
  end
  object popupCursoGrade: TPopupMenu
    Left = 328
    Top = 488
  end
  object qyListaProximaTurmaRepr: TUMZQuery
    Connection = DM.db
    ReadOnly = True
    SQL.Strings = (
      'SELECT'
  ...
  object dsListaProximaTurmaRepr: TDataSource
    DataSet = qyListaProximaTurmaRepr
    Left = 1024
    Top = 344
  end
end
