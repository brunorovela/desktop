object frmMensalidadesDivisao: TfrmMensalidadesDivisao
  ...
  object Panel1: TPanel
    ...
    object chkDescontoCond: TCheckBox
      Left = 28
      Top = 123
      Width = 157
      Height = 17
    ...
    object chkRenumerar: TCheckBox
      Left = 4
      Top = 146
      Width = 229
      Height = 17
      Caption = 'Renumerar as parcelas novas, iniciando de'
      TabOrder = 9
      OnClick = chkRenumerarClick
    end
    object speParcela: TSpinEdit
      Left = 236
      Top = 144
      Width = 64
      Height = 22
  ...
  object tblMensalidades: TUMZQuery
    ...
    object tblMensalidadescd_resp_nfse: TIntegerField
