...
begin
  ...
  begin
      ...
      // Apenas registrar na tesouraria se o valor é maior que zero.
      // Isso evita de registrar apropriação para a conta de JUROS ZERADA

      if (qGravar.ParamByName('vl_movimento').AsCurrency > 0)  then begin
