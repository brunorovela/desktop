...
uses
  ...
  ZAbstractRODataset, ZAbstractDataset, ZDataset, UZDataset, uDM, ZSqlUpdate;
...
begin
   ...
   Close;
   Bookmark := frmCobranca.cdsCobranca.GetBookmark;
   frmCobranca.cdsCobranca.DisableControls;
   frmCobranca.Filtrar;
   if frmCobranca.cdsCobranca.BookmarkValid(Bookmark) then
      frmCobranca.cdsCobranca.GotoBookmark(Bookmark);
   frmCobranca.cdsCobranca.EnableControls;
end;
