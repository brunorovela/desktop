...
type
  TfrmOnlineRestritos = class(TForm)
    Panel3: TPanel;
    Panel1: TPanel;
    grd: TDBGrid;
    Panel2: TPanel;
...
var
  frmOnlineRestritos: TfrmOnlineRestritos;
  strSenha : String;
  snSenha : string;
...
procedure TfrmOnlineRestritos.btnSairClick(Sender: TObject);
begin
  Close;
end;

procedure TfrmOnlineRestritos.btnNovoClick(Sender: TObject);
begin
  tblParam.Insert;
  grd.SetFocus;
end;

procedure TfrmOnlineRestritos.btnAlterarClick(Sender: TObject);
begin
...
procedure TfrmOnlineRestritos.btnSalvarClick(Sender: TObject);
begin
...
procedure TfrmOnlineRestritos.btnCancelarClick(Sender: TObject);
begin
  bdeDs_valor.ReadOnly := true;
  cbRestrito.Enabled := false;
...
procedure TfrmOnlineRestritos.btnExcluirClick(Sender: TObject);
begin
...
procedure TfrmOnlineRestritos.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  case Key of
...
procedure TfrmOnlineRestritos.FormShow(Sender: TObject);
begin
  tblParam.Close;
  tblParam.Open;
...
procedure TfrmOnlineRestritos.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  tblParam.Close;
...
procedure TfrmOnlineRestritos.btnFecharClick(Sender: TObject);
begin
  tblParam.Close;
...
procedure TfrmOnlineRestritos.btnInserirClick(Sender: TObject);
begin
  bdeDs_variavel.SetFocus;
...
procedure TfrmOnlineRestritos.DBEdit1Enter(Sender: TObject);
begin
   frmPrincipal.MostraHint2(Sender);
end;

procedure TfrmOnlineRestritos.bdeDs_variavelExit(Sender: TObject);
begin
...
procedure TfrmOnlineRestritos.dsParamDataChange(Sender: TObject; Field: TField);
begin
...
procedure TfrmOnlineRestritos.dsParamStateChange(Sender: TObject);
begin
...
procedure TfrmOnlineRestritos.bdeDs_variavelKeyPress(Sender: TObject;
  var Key: Char);
begin
  if Key = #13 then
  begin
...
procedure TfrmOnlineRestritos.bdeDs_variavelKeyDown(Sender: TObject;
...
procedure TfrmOnlineRestritos.bnCategoriasClick(Sender: TObject);
begin
  qyCategorias.Close;
