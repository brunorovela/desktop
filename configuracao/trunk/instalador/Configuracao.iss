...
Source: exe\dlls\*.dll; DestDir: {app}\programas\dlls\; Flags: sharedfile uninsneveruninstall overwritereadonly replacesameversion

Source: exe\mysqldump.exe; DestDir: {app}\programas\; Flags: overwritereadonly ignoreversion
Source: exe\mysql.exe; DestDir: {app}\programas\; Flags: overwritereadonly ignoreversion

[Dirs]
Name: {app}\programas\dlls
...
Name: {group}\Configurações - Backup Automático; Filename: {app}\programas\[$Modulo.NomeExecutavel$].exe; WorkingDir: {app}\programas\; IconFilename: {app}\programas\[$Modulo.NomeExecutavel$].exe; Flags: createonlyiffileexists; Parameters: backup
