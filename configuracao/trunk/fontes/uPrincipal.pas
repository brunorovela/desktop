...
uses
  ...
  ComCtrls, Menus, ExtCtrls, IniFiles, StdCtrls, ImgList, Buttons, ToolWin, General;
...
uses uDM, uSplash, uSenha, uDataHoje, uParametros, uOnline,
  ...
  uSenhas, uRelatorios, DBTables, unBAckupAgendado;
...
begin
  ...
  begin
     ...
     frmParametros.Filtra(Configuracao, '', '', frmSenha.Autorizar( 3003, taAlterar ));
  end
  else
     frmParametros.Show;
end;
