object frmReportWizard: TfrmReportWizard
  Left = 0
  Top = 0
  BorderStyle = bsDialog
  Caption = 'frmReportWizard'
  ClientHeight = 559
  ClientWidth = 794
  Color = clBtnFace
  ...
  object pnlInfo: TPanel
    ...
    Color = clWhite
    TabOrder = 0
    object btnEditQuery: TButton
      Left = 312
      Top = 10
      Width = 97
      Height = 25
      Caption = 'btnEditQuery'
      TabOrder = 0
      OnClick = btnEditQueryClick
    end
    object btnNewQuery: TButton
      Left = 440
      Top = 8
      Width = 89
      Height = 25
  ...
  object Crpe: TCrpe
    ...
    TempPath = 'C:\Users\Josimar\AppData\Local\Temp\'
    PrintDate.Day = 0
    PrintDate.Month = 0
    PrintDate.Year = 0
    Subreports.Number = 0
