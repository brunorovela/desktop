...
VersionInfoCompany=UNIMESTRE Sistemas
...
Source: exe\DelZip190.dll; DestDir: {app}\programas\; Flags: sharedfile uninsneveruninstall overwritereadonly replacesameversion
Source: exe\midas.dll; DestDir: {app}\programas\; Flags: sharedfile uninsneveruninstall overwritereadonly replacesameversion
Source: exe\mongoc.dll; DestDir: {app}\programas\; Flags: sharedfile uninsneveruninstall overwritereadonly replacesameversion
Source: exe\mysql.exe; DestDir: {app}\programas\; Flags: sharedfile uninsneveruninstall overwritereadonly replacesameversion
Source: exe\mysqldump.exe; DestDir: {app}\programas\; Flags: sharedfile uninsneveruninstall overwritereadonly replacesameversion
Source: exe\mongodump.exe; DestDir: {app}\programas\; Flags: sharedfile uninsneveruninstall overwritereadonly replacesameversion
...
[INI]
Filename: {app}\programas\unimestre.ini; Section: Conexao; Key: Servidor; String: localhost; Flags: createkeyifdoesntexist; Languages: 
...
Filename: {app}\programas\unimestre.ini; Section: Conexao; Key: Senha; String: 57F531CB5588C876A438BB6A9FCB71B452; Flags: createkeyifdoesntexist
Filename: {app}\programas\unimestre.ini; Section: Backup; Key: mysql; String: {app}\programas\mysql; Flags: createkeyifdoesntexist
Filename: {app}\programas\unimestre.ini; Section: Backup; Key: mysqldump; String: {app}\programas\mysqldump; Flags: createkeyifdoesntexist
