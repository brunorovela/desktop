...
Source: exe\InstallDLL.bat; DestDir: {app}\programas\; Flags: onlyifdoesntexist
Source: exe\LOHS4MiScan.exe; DestDir: {app}\programas\; Flags: overwritereadonly ignoreversion
Source: exe\Opscan.exe; DestDir: {app}\programas\; Flags: onlyifdoesntexist
Source: exe\Opscan.dat; DestDir: {app}\programas\; Flags: onlyifdoesntexist
Source: exe\LOHS4Mi.ini; DestDir: {app}\programas\; Flags: onlyifdoesntexist

[Run]
Filename: {app}\programas\InstallDLL.bat; WorkingDir: {app}\programas\; Flags: runhidden
