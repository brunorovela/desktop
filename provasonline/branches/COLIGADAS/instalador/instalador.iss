...
Source: exe\midas.dll; DestDir: {app}\programas; Flags: overwritereadonly ignoreversion
...
[INI]
Filename: unimestre.ini; Section: Conexao; Key: Servidor; String: localhost; Flags: createkeyifdoesntexist
Filename: unimestre.ini; Section: Conexao; Key: Banco; String: unimestre; Flags: createkeyifdoesntexist
Filename: unimestre.ini; Section: Conexao; Key: Porta; String: 3306; Flags: createkeyifdoesntexist
Filename: unimestre.ini; Section: Conexao; Key: Usuario; String: academico; Flags: createkeyifdoesntexist
Filename: unimestre.ini; Section: Conexao; Key: Senha; String: B251EA051EB116C178EF73A1579339FC2A; Flags: createkeyifdoesntexist
Filename: unimestre.ini; Section: Configuracoes; Key: Relatorios; Flags: createkeyifdoesntexist; String: {app}\relatorios
